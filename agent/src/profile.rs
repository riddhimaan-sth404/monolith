...
fn compute_parameters(pc: PcProfile, edr: EdrProfile) -> TunableParameters {
    ...
    let (
        ...
        _ => (
            base.driver_poll_interval_ms,
            base.event_batch_size,
            base.upload_interval_ms,
            base.heartbeat_interval_secs,
            base.detection_sensitivity,
            base.scanner_cooldown_secs,
            base.scanner_max_region_mb,
            base.scanner_periodic_sweep_secs,
            base.event_buffer_capacity,
            base.driver_buffer_size,
        ),
    };
