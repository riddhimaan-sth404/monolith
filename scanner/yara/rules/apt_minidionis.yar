...
rule MiniDionis_readerView {
	...
	strings:
		$s1 = "%ws_out%ws" fullword ascii /* score: '8.00' */
...
rule Malicious_SFX2 {
	...
	strings:
		...
		$s2 = "Extracting files to %s folder$Extracting files to temporary folder" fullword ascii /* PEStudio Blacklist: strings */ /* score: '26.00' */
		$s3 = "GETPASSWORD1" fullword ascii /* PEStudio Blacklist: strings */ /* score: '23.00' */
condition:
    any of them
}
