...
/* Disabled global rule to avoid applying this rule to the full concatenated
   rule set
global rule hatman_filesize : hatman {
condition:
    any of them
}
*/
