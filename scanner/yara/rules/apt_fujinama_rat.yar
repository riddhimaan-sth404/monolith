rule APT_MAL_Fujinama {
    ...
    strings:
        $kaylog_1 = "SELECT" ascii 
        $kaylog_2 = "RIGHT" ascii 
        $kaylog_3 = "HELP" ascii 
        $kaylog_4 = "WINDOWS" ascii 
        $computername = "computername" ascii 
        $useragent = "Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 5.1; SV1; .NET CLR 2.0.50727)" ascii 
        $pattern = "'()*+,G-./0123456789:" ascii 
        $function_1 = "t_save" ascii 
        $cftmon = "cftmon" ascii 
        $font = "Tahoma" ascii 
condition:
