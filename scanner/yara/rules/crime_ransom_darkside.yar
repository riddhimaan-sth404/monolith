...
rule MAL_Dropper_Win_Darkside_1 {
    ...
    strings:
        $CommonDLLs1 = "KERNEL32.dll" fullword ascii
        $CommonDLLs2 = "USER32.dll" fullword ascii
        $CommonDLLs3 = "ADVAPI32.dll" fullword ascii
        $CommonDLLs4 = "ole32.dll" fullword ascii
...
rule MAL_Backdoor_Win_C3_1 {
    ...
    strings:
        ...
        $knownDLLs1 = "WINHTTP.dll" fullword ascii
        $knownDLLs2 = "SHLWAPI.dll" fullword ascii
        $knownDLLs3 = "NETAPI32.dll" fullword ascii
        $knownDLLs4 = "ODBC32.dll" fullword ascii
