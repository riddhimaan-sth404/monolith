...
rule HDRoot_Sample_Jul17_1 {
   ...
   strings:
      ...
      $s2 = "\\DosDevices\\%ws\\system32\\%ws" ascii 
...
rule Unspecified_Malware_Jul17_1A {
   ...
   strings:
      ...
      $s3 = "ocgen.logIN" fullword ascii 
      $s4 = "ocmsn.logIN" fullword ascii 
      $s5 = "Install.log" fullword ascii 
condition:
    any of them
}