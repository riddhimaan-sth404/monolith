...
rule Foudre_Backdoor_1 {
   ...
   strings:
      $s1 = "initialization failed: Reinstall the program" fullword ascii 
      $s2 = "SnailDriver V1" fullword ascii 
      $s3 = "lp.ini" fullword ascii 
condition:
    any of them
}
...
rule Foudre_Backdoor_Dropper_1 {
   ...
   strings:
      $x1 = "536F594A96C5496CB3949A4DA4775B576E049C57696E646F77735C43757272656E7456657273696F6E5C5C52756E" fullword ascii 
      $x2 = "2220263024C380B3278695851482EC32" fullword ascii 

      $s1 = "C:\\Documents and Settings\\All Users\\Start Menu\\Programs\\\\Startup\\" ascii 
      $s2 = "C:\\Documents and Settings\\All Users\\" ascii 
      $s3 = "Software\\Microsoft\\Windows\\CurrentVersion\\Explorer\\\\Shell Folders" ascii 
      $s4 = "ShellExecuteW" fullword ascii 
condition:
    any of them
}
...
rule Foudre_Backdoor_Component_1 {
   ...
   strings:
      ...
      $s2 = "winmgmts:\\\\localhost\\root\\SecurityCenter2" fullword ascii 
      $s3 = "C:\\Documents and Settings\\All Users\\" ascii 
condition:
    any of them
}
...
rule Foudre_Backdoor_SFX {
   ...
   strings:
      ...
      $s3 = "WinRAR self-extracting archive" fullword ascii 
condition:
    any of them
}
