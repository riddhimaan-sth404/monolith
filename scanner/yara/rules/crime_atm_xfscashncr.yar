...
rule ATM_Malware_XFSCashNCR {
	...
	strings:
		...
		$x_StatusMessage1 = "[+] Ingrese Denominacion ISO" ascii
		$x_StatusMessage2 = "[+] Ingrese numero de billetes" ascii
		$x_StatusMessage3 = "[!] FAIL.. dispensadores no encontrados" ascii
		$x_StatusMessage4 = "[!] Unable continue, IMPOSIBLE abrir dispenser" ascii
		$x_PDB = "C:\\Users\\cyttek\\Downloads\\xfs_cashXP\\Debug\\xfs_cash_ncr.pdb" ascii
		$LogFile = "XfsLog.txt" ascii
