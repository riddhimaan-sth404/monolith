...
rule APT_CN_MAL_RedDelta_Shellcode_Loader_Oct20_1 {
   ...
   strings:
      ...
      $s1 = "DotNetLoader.exe" ascii fullword
      $s2 = "clipboardinject" ascii fullword
      $s3 = "download.php?raw=1" ascii 
      $s4 = "Windows NT\\CurrentVersion\\AppCompatFlags\\TelemetryController\\Levint" ascii 
      $s5 = "FlashUpdate.exe" ascii 
