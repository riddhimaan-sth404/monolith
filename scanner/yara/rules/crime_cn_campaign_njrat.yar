...
rule CN_disclosed_20180208_c {
   ...
   strings:
      $x1 = "cmd.exe /c ping 0 -n 2 & del \"" fullword ascii
      $x2 = "schtasks /create /sc minute /mo 1 /tn Server /tr " fullword ascii 
      $x3 = "www.upload.ee/image/" ascii 

      $s1 = "winmgmts:\\\\.\\root\\SecurityCenter2" fullword ascii 
      $s2 = "/Server.exe" fullword ascii 
      $s3 = "Executed As " fullword ascii 
      $s4 = "WmiPrvSE.exe" fullword ascii 
      $s5 = "Stub.exe" fullword ascii
      $s6 = "Download ERROR" fullword ascii 
      $s7 = "shutdown -r -t 00" fullword ascii 
      $s8 = "Select * From AntiVirusProduct" fullword ascii 
condition:
    any of them
}
...
rule CN_disclosed_20180208_System3 {
   ...
   strings:
      $a1 = "WmiPrvSE.exe" fullword ascii 
...
rule CN_disclosed_20180208_KeyLogger_1 {
   ...
   strings:
      $x2 = "Process already elevated." fullword ascii 
