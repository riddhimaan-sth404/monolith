...
rule Shifu_Banking_Trojan {
	...
	strings:
		...
		$s1 = "listen above" fullword ascii 
		$s2 = "familycould cost" fullword ascii 
...
rule SHIFU_Banking_Trojan {
	...
	strings:
		...
		$s1 = "USER_PRIV_GUEST" fullword ascii 
		$s2 = "USER_PRIV_ADMIN" fullword ascii 
		$s3 = "USER_PRIV_USER" fullword ascii 
