...
rule ransom_xinof 
{
   ...
   strings:
      $s1 = "XINOF.exe" ascii
      $s2 = "C:\\Users\\Phoenix" ascii
      $s3 = "How To Decrypt Files.hta" ascii
      $s4 = "C:\\ProgramData\\norunanyway" ascii
      $s5 = "C:\\ProgramData\\clast" ascii
      $s6 = "fonix1" ascii
      $s7 = "C:\\Windows\\System32\\shatdown.exe" ascii
      $s8 = "XINOF Ransomw" ascii
      $s9 = "XINOF v4.2" ascii
      $s10 = "XINOF Ransomware Version 3.3" ascii
