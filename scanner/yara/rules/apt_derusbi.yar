...
rule Derusbi_Kernel_Driver_WD_UDFS {
	...
	strings:
      $x1 = "\\\\.\\pipe\\usbpcex%d" fullword ascii 
      $x2 = "\\\\.\\pipe\\usbpcg%d" fullword ascii 
      $x3 = "\\??\\pipe\\usbpcex%d" fullword ascii 
		$x4 = "\\??\\pipe\\usbpcg%d" fullword ascii 
      ...
      $x6 = "Wrod--$$$" fullword ascii
		...
		$s3 = "\\Registry\\Machine\\SYSTEM\\CurrentControlSet\\Control\\WMI" ascii 
		$s4 = "\\Driver\\nsiproxy" ascii 
...
rule Derusbi_Backdoor_Mar17_1 {
   ...
   strings:
      $x1 = "%SystemRoot%\\System32\\wiaservc.dll" fullword ascii 
      $x2 = "c%WINDIR%\\PCHealth\\HelpCtr\\Binaries\\pchsvc.dll" fullword ascii 
      $x3 = "%Systemroot%\\Help\\perfc009.dat" fullword ascii 
      $x4 = "rundll32.exe \"%s\", R32 %s" fullword ascii
      $x5 = "OfficeUt32.dll" fullword ascii
      $x6 = "\\\\.\\pipe\\usb%so" fullword ascii 
      $x7 = "\\\\.\\pipe\\usb%si" fullword ascii 
      $x8 = "\\tmp1.dat" ascii 
condition:
    any of them
}
