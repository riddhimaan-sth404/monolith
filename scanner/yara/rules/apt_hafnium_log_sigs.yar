...
rule EXPL_LOG_CVE_2021_27065_Exchange_Forensic_Artefacts_Mar21_1 {
   ...
   strings:
      $s1 = "S:CMD=Set-OabVirtualDirectory.ExternalUrl='" ascii fullword
condition:
      1 of them
}
...
rule LOG_Exchange_Forensic_Artefacts_CleanUp_Activity_Mar21_1 {
   meta:
   ...
   strings:
      $x1 = "cmd.exe /c cd /d C:/inetpub/wwwroot/aspnet_client" ascii 
      $x2 = "cmd.exe /c cd /d C:\\inetpub\\wwwroot\\aspnet_client" ascii 
...
rule EXPL_LOG_CVE_2021_27055_Exchange_Forensic_Artefacts {
   meta:
      description = "Detects suspicious log entries that indicate requests as described in reports on HAFNIUM activity"
   ...
   strings:
      ...
      $sr1 = /\/ecp\/[0-9a-zA-Z]{1,3}\.js/ ascii /* Adjusted to cover MSF exploit https://github.com/rapid7/metasploit-framework/blob/e5c76bfe13acddc4220d7735fdc3434d9c64736e/modules/exploits/windows/http/exchange_proxylogon_rce.rb */

      $s1 = "/ecp/auth/w.js" ascii 
      $s2 = "/owa/auth/w.js" ascii 
      $s3 = "/owa/auth/x.js" ascii 
      $s4 = "/ecp/main.css" ascii 
      $s5 = "/ecp/default.flt" ascii 
      $s6 = "/owa/auth/Current/themes/resources/logon.css" ascii 
condition:
      $x1 and 1 of ($s*)
}

rule LOG_CVE_2021_27065_Exchange_Forensic_Artefacts_Mar21_2 {
   meta:
      description = "Detects suspicious log entries that indicate requests as described in reports on HAFNIUM activity"
      author = "Florian Roth (Nextron Systems)"
