...
rule CrowdStrike_SUNSPOT_02
{
    ...
    strings:
        $mutex_01 = "{12d61a41-4b74-7610-a4d8-3028d2f56395}" ascii
        $mutex_02 = "{56331e4d-76a3-0390-a7ee-567adf5836b7}" ascii

condition:
    any of them
}

rule CrowdStrike_SUNSPOT_03 
