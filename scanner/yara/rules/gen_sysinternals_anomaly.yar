...
rule SysInternals_Tool_Anomaly {
   ...
   strings:
      ...
      $n1 = "Mark Russinovich" ascii

      $nfp1 = "<<<Obsolete>>>" fullword ascii 
      $nfp2 = "BGInfo - Wallpaper text configurator" ascii 
      $nfp3 = "usage: movefile [source] [dest]" ascii 
      $nfp4 = "LoadOrder information has been copied" ascii 
      $nfp5 = "Cache working set cleared" ascii 
condition:
    any of them
}
