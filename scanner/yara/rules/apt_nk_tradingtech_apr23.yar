...
rule APT_NK_MAL_M_Hunting_VEILEDSIGNAL_2 {
   ...
   strings:
      ...
      $si1 = "CryptBinaryToStringA" fullword ascii
      $si2 = "BCryptGenerateSymmetricKey" fullword ascii
      $si3 = "CreateThread" fullword ascii
      $ss1 = "ChainingModeGCM" ascii 
      $ss2 = "__tutma" fullword ascii
condition:
...
rule APT_NK_MAL_M_Hunting_VEILEDSIGNAL_3 {
   ...
   strings:
      ...
      $si1 = "HttpSendRequestW" fullword ascii
      $si2 = "CreateNamedPipeW" fullword ascii
      $si3 = "CreateThread" fullword ascii
      $se1 = "DllGetClassObject" fullword ascii
condition:
      (uint16(0) == 0x5A4D) and (uint32(uint32(0x3C)) == 0x00004550) and (uint16(uint32(0x3C)+0x18) == 0x020B) and all of them
}
...
rule APT_NK_MAL_M_Hunting_VEILEDSIGNAL_4 {
   ...
   strings:
      ...
      $si1 = "CreateThread" fullword ascii
      $si2 = "MultiByteToWideChar" fullword ascii
      $si3 = "LocalAlloc" fullword ascii
      $se1 = "DllGetClassObject" fullword ascii
condition:
      (uint16(0) == 0x5A4D) and (uint32(uint32(0x3C)) == 0x00004550) and (uint16(uint32(0x3C)+0x18) == 0x020B) and all of them
}
...
rule APT_NK_MAL_M_Hunting_VEILEDSIGNAL_5 {
   ...
   strings:
      ...
      $ss1 = "chrome.exe" ascii fullword
      $ss2 = "firefox.exe" ascii fullword
      $ss3 = "msedge.exe" ascii fullword
...
rule APT_NK_MAL_M_Hunting_VEILEDSIGNAL_6 {
   ...
   strings:
      $ss1 = "C:\\Programdata\\" ascii 
      $ss2 = "devobj.dll" ascii fullword
      $ss3 = "msvcr100.dll" ascii fullword
      $ss4 = "TpmVscMgrSvr.exe" ascii fullword
      $ss5 = "\\Microsoft\\Windows\\TPM" ascii fullword
...
rule SUSP_NK_MAL_M_Hunting_POOLRAT {
   ...
   strings:
      ...
      */
      $s4 = "name=\"token\"%s%s%u%s" ascii
      $str1 = "--N9dLfqxHNUUw8qaUPqggVTpX-" ascii 
condition:
      any of ($s*) or $str1
}
...
rule APT_NK_TradingTech_ForensicArtifacts_Apr23_1 {
   ...
   strings:
      $x1 = "www.tradingtechnologies.com/trading/order-management" ascii 
      
      $xf1 = "X_TRADER_r7.17.90p608.exe" ascii 
      $xf2 = "\\X_TRADER-ja.mst" ascii 
      $xf3 = "C:\\Programdata\\TPM\\TpmVscMgrSvr.exe" ascii 
      $xf4 = "C:\\Programdata\\TPM\\winscard.dll" ascii 
