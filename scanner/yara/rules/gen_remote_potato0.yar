...
rule HKTL_SentinelOne_RemotePotato0_PrivEsc {
   ...
   strings:    
      ...
      $istorage_clsid = "{00000306-0000-0000-c000-000000000046}" ascii 
      $meow_header = { 4d 45 4f 57 }
      $clsid1 = "{11111111-2222-3333-4444-555555555555}" ascii
      $clsid2 = "{5167B42F-C111-47A1-ACC4-8EABE61B0B54}" ascii
condition:
