...
rule DLL_Injector_Lynx {
   ...
   strings:
      $x1 = " -p <TARGET PROCESS NAME> | -u <DLL PAYLOAD> [--obfuscate]" fullword ascii 
      $x2 = "You've selected to inject into process: %s" fullword ascii 
      $x3 = "Lynx DLL Injector" fullword ascii 
      $x4 = "Reflective DLL Injector" fullword ascii 
      $x5 = "Failed write payload: %lu" fullword ascii 
      $x6 = "Failed to start payload: %lu" fullword ascii 
      $x7 = "Injecting payload..." fullword ascii 
condition:
    any of them
}
