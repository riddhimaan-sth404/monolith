...
rule APT_APT29_Win_FlipFlop_LDR {
   meta:
...
rule APT_APT29_NOBELIUM_LNK_NV_Link_May21_2 {
   ...
   strings:
      $s1 = "RegisterOCX BOOM" ascii 
      $s2 = "cmd.exe /c start BOOM.exe" ascii 
condition:
    any of them
}
...
rule APT_APT29_NOBELIUM_LNK_Samples_May21_1 {
   ...
   strings:
      $a1 = "rundll32.exe" ascii 

      $sa1 = "IMGMountingService.dll" ascii 
      $sa2 = "MountImgHelper" ascii 

      $sb1 = "diassvcs.dll" ascii 
      $sb2 = "InitializeComponent" ascii 

      $sc1 = "MsDiskMountService.dll" ascii 
      $sc2 = "DiskDriveIni" ascii 

      $sd1 = "GraphicalComponent.dll" ascii 
      $sd2 = "VisualServiceComponent" ascii 

      $se1 = "data/mstu.dll,MicrosoftUpdateService" ascii 
condition:
    any of them
}
...
rule APT_APT29_NOBELIUM_BoomBox_May21_1 {
   ...
   strings:
      ...
      $a1 = "]::FromBase64String($" ascii 

      $xa1 = "123do3y4r378o5t34onf7t3o573tfo73" ascii fullword
      $xa2 = "1233t04p7jn3n4rg" ascii fullword
...
rule APT_APT29_NOBELIUM_BoomBox_May21_2 {
   ...
   strings:
      $x1 = "\\Microsoft\\NativeCache\\NativeCacheSvc.dll" ascii 
      $x2 = "\\NativeCacheSvc.dll _configNativeCache" ascii 
      
      $a1 = "/content.dropboxapi.com" ascii fullword
      
      $s1 = "rundll32.exe {0} {1}" ascii fullword
      $s2 = "\\\\CertPKIProvider.dll" ascii 
      $s3 = "/tmp/readme.pdf" ascii 
      $s4 = "temp/[^\"]*)\"" ascii fullword
...
rule APT_APT29_NOBELIUM_Stageless_Loader_May21_2 {
   ...
   strings:
      ...
      $s1 = "c:\\users\\devuser\\documents" ascii fullword 
