rule Ryuk_Ransomware {
   ...
   strings:
      ...
      $x2 = "\\System32\\cmd.exe" fullword ascii 
      $s1 = "C:\\Users\\Admin\\Documents\\Visual Studio 2015\\Projects\\ConsoleApplication54new crypted" ascii
      $s2 = "fg4tgf4f3.dll" fullword ascii 
      $s3 = "lsaas.exe" fullword ascii 
      $s4 = "\\Documents and Settings\\Default User\\sys" fullword ascii 
      $s5 = "\\Documents and Settings\\Default User\\finish" fullword ascii 
      $s6 = "\\users\\Public\\sys" fullword ascii 
      $s7 = "\\users\\Public\\finish" fullword ascii 
      $s8 = "You will receive btc address for payment in the reply letter" fullword ascii
      $s9 = "hrmlog" fullword ascii 
      $s10 = "No system is safe" fullword ascii
      $s11 = "keystorage2" fullword ascii 
      $s12 = "klnagent" fullword ascii 
      $s13 = "sqbcoreservice" fullword ascii 
      $s14 = "tbirdconfig" fullword ascii 
      $s15 = "taskkill" fullword ascii 
...
rule Ransom_Ryuk_sept2020 {
   ...
   strings:
      ...
      $x7 = "/C REG ADD \"HKEY_CURRENT_USER\\SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Run\" /v \"EV\" /t REG_SZ /d \"" fullword ascii
      $x8 = "W/C REG DELETE \"HKEY_CURRENT_USER\\SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Run\" /v \"EV\" /f" fullword ascii
      $x9 = "\\System32\\cmd.exe" fullword ascii 
      $s10 = "Ncsrss.exe" fullword ascii 
      $s11 = "lsaas.exe" fullword ascii 
      $s12 = "lan.exe" fullword ascii 
      $s13 = "$WGetCurrentProcess" fullword ascii
      $s14 = "\\Documents and Settings\\Default User\\sys" fullword ascii 
      $s15 = "Ws2_32.dll" fullword ascii
      $s16 = " explorer.exe" fullword ascii 
      $s17 = "e\\Documents and Settings\\Default User\\" fullword ascii 
      $s18 = "\\users\\Public\\" fullword ascii
      $s19 = "\\users\\Public\\sys" fullword ascii 
...
rule RANSOM_RYUK_May2021
{
	...
	strings:
		$ryuk_filemarker = "RYUKTM" fullword ascii
