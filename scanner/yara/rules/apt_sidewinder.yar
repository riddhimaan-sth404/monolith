...
rule APT_SideWinder_NET_Loader_Aug_2020_1 {
   ...
   strings:
      $a1 = "DUSER.dll" fullword ascii 
      
      $s1 = "UHJvZ3JhbQ==" fullword ascii // encoded string -> 'Program' -> Invoke call decoded PE
      $s2 = "U3RhcnQ=" fullword ascii 
      $s3 = ".tmp           " fullword ascii 
      $s4 = "FileRipper" fullword ascii
      $s5 = "copytight @" fullword ascii 
condition:
    any of them
}
