...
rule Pirpi_1609_A {
	...
	strings:
		...
		$s1 = "flvUpdate.exe" fullword ascii 
		$s2 = "www.ThinkWorking.com" fullword ascii 
		...
		$s7 = "GetApp03" fullword ascii 
		$s8 = "flvUpdate" fullword ascii 
		$s9 = "%d-%4.4d%d" fullword ascii
		$s10 = "http://%s/%5.5d.html" fullword ascii
		$s11 = "flvbho.exe" fullword ascii 
