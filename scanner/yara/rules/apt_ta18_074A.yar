...
rule WEBSHELL_Z_Webshell_2 {
   ...
   strings:
      $webshell_name = "public string z_progname =" ascii 
      $webshell_password = "public string Password =" ascii 
condition:
    any of them
}
...
rule TA18_074A_screen {
   ...
   strings:
      ...
      $s5 = "Too many arguments, going to store in current dir" fullword ascii 
condition:
    any of them
}
