...
rule Winnti_malware_Nsiproxy {
	...
	strings:
		...
		$a1 = "\\Device\\StreamPortal" ascii 
		$a2 = "\\Device\\PNTFILTER" ascii 

		$s1 = "Cookie: SN=" fullword ascii
		$s2 = "\\BaseNamedObjects\\_transmition_synchronization_" ascii 
		$s3 = "Winqual.sys" fullword ascii 
		$s4 = "\\Registry\\Machine\\SYSTEM\\CurrentControlSet\\Control\\Class\\{4D36E972-E325-11CE-BFC1-08002BE10318}" ascii 
...
rule Winnti_malware_UpdateDLL {
	...
	strings:
		...
		$s1 = "\\Registry\\User\\%s\\Software\\Microsoft\\Windows\\CurrentVersion\\Internet Settings" ascii 
		$s2 = "Update.dll" fullword ascii
		$s3 = "\\\\.\\pipe\\usbpcex%d" fullword ascii 
		$s4 = "\\\\.\\pipe\\usbpcg%d" fullword ascii 
		$s5 = "\\Registry\\Machine\\SYSTEM\\CurrentControlSet\\Control\\WMI" ascii 
		$s6 = "\\??\\pipe\\usbpcg%d" fullword ascii 
		$s7 = "\\??\\pipe\\usbpcex%d" fullword ascii 
...
rule Winnti_malware_FWPK {
   ...
   strings:
      $s0 = "\\Registry\\Machine\\System\\CurrentControlSet\\Control\\Class\\{4D36E972-E325-11CE-BFC1-08002BE10318}\\" ascii 
      $s1 = "%x:%d->%x:%d, Flag %s%s%s%s%s, seq %u, ackseq %u, datalen %u" fullword ascii
      $s2 = "FWPKCLNT.SYS" fullword ascii
      $s3 = "Port Layer" fullword ascii 
      $s4 = "%x->%x, icmp type %d, code %d" fullword ascii
      $s5 = "\\BaseNamedObjects\\{93144EB0-8E3E-4591-B307-8EEBFE7DB28E}" ascii 
      $s6 = "\\Ndi\\Interfaces" ascii 
      $s7 = "\\Device\\{93144EB0-8E3E-4591-B307-8EEBFE7DB28F}" ascii 
      $s8 = "Bad packet" fullword ascii
      $s9 = "\\BaseNamedObjects\\EKV0000000000" ascii 
...
rule Winnti_malware_StreamPortal_Gen {
	...
	strings:
		$s0 = "Proxies destination address/port for TCP" fullword ascii 
		$s3 = "\\Device\\StreamPortal" ascii 
		$s4 = "Transport-Data Proxy Sub-Layer" fullword ascii 
		$s5 = "Cookie: SN=" fullword ascii
		$s6 = "\\BaseNamedObjects\\_transmition_synchronization_" ascii 
		$s17 = "NTOSKRNL.EXE" fullword ascii /* Goodware String - occured 4 times */
...
rule APT_Winnti_MAL_Dec19_1 {
   ...
   strings:
      $e1 = "Global\\BFE_Notify_Event_{65a097fe-6102-446a-9f9c-55dfc3f411015}" ascii 
      $e2 = "Global\\BFE_Notify_Event_{65a097fe-6102-446a-9f9c-55dfc3f411014}" ascii 
      $e3 = "Global\\BFE_Notify_Event_{65a097fe-6102-446a-9f9c-55dfc3f411016}" ascii 
      $e4 = "\\BaseNamedObjects\\{B2B87CCA-66BC-4C24-89B2-C23C9EAC2A66}" ascii 
      $e5 = "BFE_Notify_Event_{7D00FA3C-FBDC-4A8D-AEEB-3F55A4890D2A}" 
...
rule APT_Winnti_MAL_Dec19_2 {
   ...
   strings:
      $a1 = "IPSecMiniPort" ascii fullword
      $a2 = "ndis6fw" ascii fullword
      $a3 = "TCPIP" ascii fullword
      $a4 = "NDIS.SYS" ascii fullword
      $a5 = "ntoskrnl.exe" ascii fullword
      $a6 = "\\BaseNamedObjects\\{B2B87CCA-66BC-4C24-89B2-C23C9EAC2A66}" ascii 
      $a7 = "\\Device\\Null" ascii 
      $a8 = "\\Device" ascii 
      $a9 = "\\Driver" ascii 
      $b1 = { 66 81 7? ?? 70 17 }
      $b2 = { 81 7? ?? 07 E0 15 00 }
...
rule APT_Winnti_MAL_Dec19_5 {
   ...
   strings:
      ...
      $a7 = "cmd.exe" ascii 
      $a8 = ",XML" ascii 
      $a9 = "\\rundll32.exe" ascii 
      $a10 = "\\conhost.exe" ascii 
      $a11 = "\\cmd.exe" ascii 
...
rule winnti_dropper_x64_libtomcrypt_fns {
   meta:
...
rule winnti_dropper_x86_libtomcrypt_fns {
   meta:
      author = "CarbonBlack Threat Research" // tharuyama
      date = "2019-08-26"
