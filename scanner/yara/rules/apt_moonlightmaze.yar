...
strings:
	...
	$a1="Write file Ok..." ascii 
	$a2="ERROR: Can not open socket...." ascii 
	$a3="Error in parametrs:" ascii 
	$a4="Usage: @<get/put> <IP> <PORT> <file>" ascii 
	$a5="ERROR: Not connect..." ascii 
	$a6="Connect successful...." ascii 
	$a7="clnt <%d> rqstd n ll kll" ascii 
	$a8="clnt <%d> rqstd swap" ascii 
	$a9="cld nt sgnl prcs grp" ascii 
	$a10="cld nt sgnl prnt" ascii 
...
strings:
	...
	//strings from ora ->
	$a1="/var/tmp/gogo" fullword ascii
	$a2="myfilename= |%s|" fullword ascii
	$a3="mypid,mygid=" fullword ascii
	$a4="mypid=|%d| mygid=|%d|" fullword ascii

	//strings from tdn ->
	$a5="/var/tmp/task" fullword ascii
	$a6="mydevname= |%s|" fullword ascii
...
strings:
	...
	$a1="./a filename template_file" ascii 
	$a2="May be %s is empty?" ascii 
	$a3="template string = |%s|" ascii 
	$a4="No blocks !!!"
	$a5="No data in this block !!!!!!" ascii 
	$a6="No good line"
...
strings:
	...
	$a3="/var/tmp/task" fullword ascii
	$a4="/var/tmp/taskhost" fullword ascii
	$a5="my hostname: %s"
	$a6="/var/tmp/tasklog"
	$a7="/var/tmp/.Xtmp01" fullword ascii
	$a8="myfilename=-%s-"
	$a9="/var/tmp/taskpid"
	$a10="mypid=-%d-" fullword ascii
	$a11="/var/tmp/taskgid" fullword ascii
	$a12="mygid=-%d-" fullword ascii
