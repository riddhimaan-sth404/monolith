...
rule apt_CN_Tetrisplugins_JS    
{
	...
	strings:
		...
		// Some of the same strings in , in case the attacker change their obfuscation there
		$e1 = "Cannot\x20call\x20a\x20class\x20as\x20a\x20function" 
		$e2 = "The\x20command\x20is\x20sent\x20successfully,\x20wait\x20for\x20the\x20result\x20to\x20return" 
		$e3 = "getUserMedia\x20is\x20not\x20implemented\x20in\x20this\x20browser" 
		$e4 = "http://bn6kma5cpxill4pe.onion/static/images/tor-logo1x.png" 
		$e5 = "/public/dependence/jquery" 
		$e6 = "\x20\x22*\x22)\x0a\x20\x20}\x0a\x20\x20document.documentElement.appendChild(" 
		$e8 = "\x0a\x20\x20var\x20data\x20=\x20{}\x0a\x20\x20window.c\x20=\x200\x0a\x20\x20script2\x20=\x20document.createElement(\x22script\x22)\x0a\x20\x20script2.async\x20=\x20true\x0a\x20\x20script2.src\x20=\x20\x22" 
		$e9 = "{isPluginCallback:\x20true,\x20data,\x20plugin:\x20" 
