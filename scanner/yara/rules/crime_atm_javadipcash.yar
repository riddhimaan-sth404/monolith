rule ATM_Malware_JavaDispCash {
	...
	strings:
		$CashInfo = "getNumberOfCashUnits" ascii 
		$Dispense = "waitforbillstaken" ascii 
		$Inject = "No code to inject!" ascii 
		$config = ".Agentcli" ascii 
		$log1 = "logft.log" ascii 
		$log2 = ".loginside" ascii 
