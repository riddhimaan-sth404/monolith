...
rule SUSP_RDP_File_Indicators_Oct24_1 {
   ...
   strings:
      $s1 = "redirectclipboard:i:1" ascii fullword
      $s2 = "redirectprinters:i:1" ascii fullword
      $s3 = "remoteapplicationmode:i:1" ascii fullword
      $s4 = "username:s:" ascii 
      $s5 = "emoteapplicationicon:s:C:\\Windows\\SystemApps" ascii 
condition:
    any of them
}
