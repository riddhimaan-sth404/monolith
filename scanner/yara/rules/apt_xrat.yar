...
rule xRAT_1 {
   ...
   strings:
      $x1 = "\" -CHECK & PING -n 2 127.0.0.1 & EXIT" fullword ascii
      $x2 = "xClient.Core.Elevation" fullword ascii
      $x3 = ">> Welcome to MAX-Shell :Session created" fullword ascii 
      ...
      $s1 = "ping -n 20 localhost > nul" fullword ascii 
      $s2 = "DownloadAndExecute" fullword ascii
      $s3 = "Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/35.0.1916.114 Safari/537.36" fullword ascii 
      $s4 = "Client.exe" fullword ascii
      $s5 = "Microsoft -Defender" fullword ascii 
      $s6 = "Microsoft- Defender" fullword ascii 
