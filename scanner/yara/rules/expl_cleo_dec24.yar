...
rule EXPL_Cleo_Exploitation_Log_Indicators_Dec24 {
   meta:
   ...
   strings:
      $x1 = "Note: Processing autorun file 'autorun\\health" ascii 
      $x2 = "60282967-dc91-40ef-a34c-38e992509c2c.xml" ascii 
      $x3 = "<Detail level=\"1\">Executing 'cmd.exe /c \"powershell -NonInteractive -EncodedCommand " ascii
condition:
      1 of them
}
...
rule EXPL_Cleo_Exploitation_PS1_Indicators_Dec24 {
   meta:
   ...
   strings:
      $xe1 = "Start-Process -WindowStyle Hidden -FilePath jre\\bin\\java.exe" ascii 
      $xe2 = "$f=\"cleo." ascii
      $xe3 = "<Detail level=\"1\">Executing 'cmd.exe /c \"powershell -NonInteractive -EncodedCommand " ascii

      $x1 = "$f=\"cleo." ascii
      $x2 = "<Detail level=\"1\">Executing 'cmd.exe /c \"powershell -NonInteractive -EncodedCommand " ascii
condition:
      1 of them
}
