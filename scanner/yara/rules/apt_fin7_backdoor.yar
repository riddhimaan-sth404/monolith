...
rule FIN7_Dropper_Aug17 {
   ...
   strings:
      ...
      $s2 = "PROJECT.THISDOCUMENT.AUTOOPEN" fullword ascii 
      $s3 = "Project.ThisDocument.AutoOpen" fullword ascii 
      $s4 = "\\system3" ascii
...
rule FIN7_Backdoor_Aug17 {
   ...
   strings:
      ...
      $x3 = "schtasks /Create /f /tn \"GoogleUpdateTaskMachineSystem\" /tr \"wscript.exe" ascii
      $x4 = "schtasks /Delete /F /TN \"\"GoogleUpdateTaskMachineCore" ascii
      $x5 = "schtasks /Delete /F /TN \"GoogleUpdateTaskMachineCore" ascii
