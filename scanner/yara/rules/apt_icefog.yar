...
rule IceFog_Malware_Feb18_1 {
   ...
   strings:
      ...
      $s3 = "c:\\windows\\debug\\wia\\help" fullword ascii 
      $s4 = "/getorder.aspx?hostname=" fullword ascii 
      $s5 = "\\filecfg_temp.dat" ascii 
      $s6 = "Unknown operating system " fullword ascii 
      $s7 = "kastygost.compress.to" fullword ascii 
      $s8 = "/downloads/" ascii 
      $s9 = "\\key.dat" ascii 
condition:
    any of them
