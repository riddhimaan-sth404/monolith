rule MAL_Passwordstate_Moserware_Backdoor_Apr21_1 {
   ...
   strings:
      $x1 = "https://passwordstate-18ed2.kxcdn.com" ascii 

      $s1 = " ProxyUserName, ProxyPassword FROM [SystemSettings]" ascii fullword
      $s2 = "PasswordstateService.Passwordstate.Crypto" ascii 
      $s3 = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/89.0.4389.128 Safari" ascii fullword
