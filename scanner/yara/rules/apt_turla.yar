...
rule RUAG_APT_Malware_Gen2 {
   ...
   strings:
      ...
      $s1 = "MSIMGHLP.DLL" fullword ascii 
      $s2 = "msimghlp.dll" fullword ascii
...
rule APT_MAL_TinyTurla_Sep21_1 {
	...
	strings:
		$a = "Title: " fullword ascii 
		$b = "Hosts" fullword ascii 
		$c = "Security" fullword ascii 
		$d = "TimeLong" fullword ascii 
		$e = "TimeShort" fullword ascii 
		$f = "MachineGuid" fullword ascii 
		$g = "POST" fullword ascii 
