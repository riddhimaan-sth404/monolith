...
rule APT28_SourFace_Malware1 {
	...
	strings:
		...
		$s1 = "Core Shell Runtime Service" fullword ascii /* PEStudio Blacklist: strings */
		$s2 = "\\chkdbg.log" ascii 
condition:
    any of them
}
...
rule APT28_SkinnyBoy_Implanter {
   meta:
