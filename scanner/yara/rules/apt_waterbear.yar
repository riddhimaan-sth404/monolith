...
rule Waterbear_2_Jun17 {
   ...
   strings:
      ...
      $s4 = "UI look 2003" fullword ascii 
condition:
    any of them
}
...
rule Waterbear_7_Jun17 {
   ...
   strings:
      $s1 = "Bluthmon.exe" fullword ascii 
      $s2 = "Motomon.exe" fullword ascii 
...
rule Waterbear_8_Jun17 {
   ...
   strings:
      ...
      $s2 = "ADVPACK32.DLL" fullword ascii 
...
rule Waterbear_9_Jun17 {
   ...
   strings:
      $s1 = "ADVPACK32.DLL" fullword ascii 
      $s2 = "ADVPACK32" fullword ascii 
...
rule Waterbear_11_Jun17 {
   ...
   strings:
      $s1 = "/Pages/%u.asp" fullword ascii 
      $s2 = "NVIDIA Corporation." fullword ascii 
      $s3 = "tqxbLc|fP_{eOY{eOX{eO" fullword ascii
      $s4 = "Copyright (C) 2005" fullword ascii 
condition:
    any of them
}
