rule EXT_HKTL_MAL_TinyShell_Backdoor {
   ...
   strings:
      ...
      $ss1 = "fork" ascii fullword 
      $ss2 = "socket" ascii fullword 
      $ss3 = "bind" ascii fullword 
      $ss4 = "listen" ascii fullword 
      $ss5 = "accept" ascii fullword 
      $ss6 = "alarm" ascii fullword 
      $ss7 = "shutdown" ascii fullword 
      $ss8 = "creat" ascii fullword 
      $ss9 = "write" ascii fullword 
      $ss10 = "open" ascii fullword 
      $ss11 = "read" ascii fullword 
      $ss12 = "execl" ascii fullword 
      $ss13 = "gethostbyname" ascii fullword 
      $ss14 = "connect" ascii fullword 
condition:
