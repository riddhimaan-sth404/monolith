...
rule CheshireCat_Gen1 {
	...
	strings:
		$x1 = "CAPESPN.DLL" fullword ascii 
		$x2 = "WINF.DLL" fullword ascii 
		$x3 = "NCFG.DLL" fullword ascii 
		$x4 = "msgrthlp.dll" fullword ascii 
		...
		$b1 = "Windows Shell Icon Handler" fullword ascii 
		$b2 = "Microsoft Shell Icon Handler" fullword ascii 
