...
rule FVEY_ShadowBrokers_Jan17_Screen_Strings {
   ...
   strings:
      $x1 = "Danderspritz" ascii fullword
      $x2 = "DanderSpritz" ascii fullword
      $x3 = "PeddleCheap" ascii fullword
      $x4 = "ChimneyPool Addres" ascii fullword
      ...
      $d1 = "Mcl_NtElevation" fullword ascii 
      $d2 = "Mcl_NtNativeApi" fullword ascii 
      $d3 = "Mcl_ThreatInject" fullword ascii 
      $d4 = "Mcl_NtMemory" fullword ascii 
condition:
    any of them
}
