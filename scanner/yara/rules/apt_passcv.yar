...
rule PassCV_Sabre_Malware_1 {
   ...
   strings:
      ...
      $s2 = "https://www.baidu.com/s?ie=utf-8&f=8&rsv_bp=0&rsv_idx=1&tn=baidu&wd=ip138" fullword ascii 
      $s3 = "CloudRun.exe" fullword ascii 
      $s4 = "SaberSvcB.exe" fullword ascii 
      $s5 = "SaberSvc.exe" fullword ascii 
      $s6 = "SaberSvcW.exe" fullword ascii 
      $s7 = "tianshiyed@iaomaomark1#23mark123tokenmarkqwebjiuga664115" fullword ascii 
...
rule PassCV_Sabre_Malware_Excalibur_1 {
   ...
   strings:
      ...
      $x3 = "SaberSvc.exe" ascii 

      $s1 = "BBB.exe" fullword ascii 
      $s2 = "AAA.exe" fullword ascii 
condition:
    any of them
}
...
rule PassCV_Sabre_Malware_3 {
   ...
   strings:
      $x1 = "NXKILL" fullword ascii 

      $s1 = "2OLE32.DLL" fullword ascii
      $s2 = "localspn.dll" fullword ascii 
...
rule PassCV_Sabre_Malware_4 {
   ...
   strings:
      $s1 = "QWNjZXB0On" fullword ascii /* encoded string 'Accept:' */
...
rule PassCV_Sabre_Tool_NTScan {
   ...
   strings:
      $x1 = "NTscan.EXE" fullword ascii 
      $x2 = "NTscan Microsoft " fullword ascii 
...
rule PassCV_Sabre_Malware_5 {
   ...
   strings:
      ...
      $s2 = "BitLocker.exe" fullword ascii 
      $s3 = "|xtplhd" fullword ascii /* reversed goodware string 'dhlptx|' */
      $s4 = "SERVICECORE" fullword ascii 
      $s5 = "SHARECONTROL" fullword ascii 
condition:
    any of them
}
