...
rule Ransom_LockerGoga_Mar19_1 {
   ...
   strings:
      $x1 = "\\.(doc|dot|wbk|docx|dotx|docb|xlm|xlsx|xltx|xlsb|xlw|ppt|pot|pps|pptx|potx|ppsx|sldx|pdf)" ascii 
      $x2 = "|[A-Za-z]:\\cl.log" ascii 
      ...
      $xc2 = { 00 2E 00 6C 00 6F 00 63 00 6B 00 65 00 64 00 00
               ...
               69 6F 6E }
      $rn1 = "This may lead to the impossibility of recovery of the certain files." ascii 
condition:
    any of them
}
