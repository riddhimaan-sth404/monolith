...
rule COZY_FANCY_BEAR_Hunt {
	...
	strings:
		$s1 = "185.100.84.134" ascii fullword
		$s2 = "58.49.58.58" ascii fullword
		$s3 = "218.1.98.203" ascii fullword
		$s4 = "187.33.33.8" ascii fullword
		$s5 = "185.86.148.227" ascii fullword
		$s6 = "45.32.129.185" ascii fullword
		$s7 = "23.227.196.217" ascii fullword
condition:
