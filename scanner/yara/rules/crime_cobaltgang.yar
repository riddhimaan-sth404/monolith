...
rule CobaltGang_Malware_Aug17_1 {
   ...
   strings:
      $s1 = "ServerSocket.EXE" fullword ascii 
      $s2 = "Incorrect version of WS2_32.dll found" fullword ascii
      $s3 = "Click 'Connect' to Connect to the Server.  'Disconnect' to disconnect from server." fullword ascii 
      $s4 = "Click 'Start' to start the Server.  'Stop' to Stop it." fullword ascii 
condition:
    any of them
}
