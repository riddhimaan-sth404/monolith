...
rule SUSP_PE_Signed_by_Suspicious_Entitiy_Mar23
{
    ...
    strings:
        ...
        $cert1 = "91210242MA0YGH36" ascii ///serialNumber=91210242MA0YGH36XJ/jurisdictionC=CN/businessCategory=Private Organization/C=CN/ST=\xE8\xBE\xBD\xE5\xAE\x81\xE7\x9C\x81
        $cert2 = "Copyright (C) 2013-2021 QuickZip. All rights reserved." ascii 
        $cert3 = "Qi Lijun" ascii // short but no fp
        ...
        $cert5 = "Luck Bigger Technology Co., Ltd" ascii
        ...
        $cert7 = "XinSing Network Service Co., Ltd" ascii
        $cert8 = "Hangzhou Shunwang Technology Co.,Ltd" ascii
        $cert9 = "Zhuhai liancheng Technology Co., Ltd." ascii
