...
rule Greenbug_Malware_3 {
   ...
   strings:
      ...
      $x2 = "C:\\ddd\\wer2.txt" fullword ascii 
      $x3 = "\\Microsoft\\Windows\\tmp43hh11.txt" ascii 
condition:
      1 of them
}
