...
rule Suspicious_PowerShell_Code_1 {
   ...
   strings:
      ...
      $s3 = /IEX $[a-zA-Z]{1,8}.downloadstring\(["']http/ ascii
		$s4 = "powershell.exe -w hidden -ep bypass -Enc" ascii
		$s5 = "-w hidden -noni -nop -c \"iex(New-Object" ascii
		$s6 = "powershell.exe reg add HKCU\\software\\microsoft\\windows\\currentversion\\run" 
condition:
      1 of them
}
...
rule Suspicious_PowerShell_WebDownload_1 {
   ...
   strings:
      $s1 = "System.Net.WebClient).DownloadString(\"http" ascii
      $s2 = "System.Net.WebClient).DownloadString('http" ascii 
      $s3 = "system.net.webclient).downloadfile('http" ascii 
      $s4 = "system.net.webclient).downloadfile(\"http" ascii
      $s5 = "GetString([Convert]::FromBase64String(" ascii 
      ...
      $fpg5 = "License"
      $fpg6 = "<?xml"
      $fpg7 = "Help" fullword ascii
      $fpg8 = "COPYRIGHT" fullword ascii
condition:
...
rule Susp_PowerShell_Sep17_1 {
   ...
   strings:
      $x1 = "Process.Create(\"powershell.exe -nop -w hidden" fullword ascii
...
rule SUSP_PS1_FromBase64String_Content_Indicator {
   meta:
      description = "Detects suspicious  encoded PowerShell expressions"
      author = "Florian Roth (Nextron Systems)"
      reference = "https://gist.github.com/Neo23x0/6af876ee72b51676c82a2db8d2cd3639"
      date = "2020-01-25"
      id = "326c83ff-5d21-508f-b935-03ccdab6efa7"
   strings:
      $ = "::FromBase64String(\"H4s" ascii
      $ = "::FromBase64String(\"TVq" ascii
      $ = "::FromBase64String(\"UEs" ascii
      $ = "::FromBase64String(\"JAB" ascii
      $ = "::FromBase64String(\"SUVY" ascii
      $ = "::FromBase64String(\"SQBFAF" ascii
      $ = "::FromBase64String(\"SQBuAH" ascii
      $ = "::FromBase64String(\"PAA" ascii
      $ = "::FromBase64String(\"cwBhA" ascii
      $ = "::FromBase64String(\"aWV4" ascii
      $ = "::FromBase64String(\"aQBlA" ascii
      $ = "::FromBase64String(\"R2V0" ascii
      $ = "::FromBase64String(\"dmFy" ascii
      $ = "::FromBase64String(\"dgBhA" ascii
      $ = "::FromBase64String(\"dXNpbm" ascii
      $ = "::FromBase64String(\"H4sIA" ascii
      $ = "::FromBase64String(\"Y21k" ascii
      $ = "::FromBase64String(\"Qzpc" ascii
      $ = "::FromBase64String(\"Yzpc" ascii
      $ = "::FromBase64String(\"IAB" ascii
