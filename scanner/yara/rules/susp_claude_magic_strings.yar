rule SUSP_Claude_Refusal_Magic_String_Jan26 {
   ...
   strings:
      $x1 = "ANTHROPIC_MAGIC_STRING_TRIGGER_REFUSAL_" ascii 
condition:
      $x1
}
...
rule MAL_Claude_Refusal_Magic_String_Jan26 {
   ...
   strings:
      $xb1 = "ANTHROPIC_MAGIC_STRING_TRIGGER_REFUSAL_" ascii 
condition:
      $xb1
}
...
rule SUSP_Claude_Redacted_Thinking_Magic_String_Jan26_1 {
   ...
   strings:
      $x1 = "ANTHROPIC_MAGIC_STRING_TRIGGER_REDACTED_THINKING_" ascii 
condition:
      $x1
}
...
rule SUSP_Claude_Redacted_Thinking_Magic_String_Jan26_2 {
   ...
   strings:
      $xb1 = "ANTHROPIC_MAGIC_STRING_TRIGGER_REDACTED_THINKING_" ascii 
condition:
      $xb1
}
