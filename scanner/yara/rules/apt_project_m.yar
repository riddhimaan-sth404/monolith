...
rule ProjectM_CrimsonDownloader {
	...
	strings:
		...
		$s2 = "secure_scan.exe" fullword ascii 
		$s3 = "SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Run|mswall" fullword ascii 
		$s4 = "secure_scan|mswall" fullword ascii 
		$s5 = "[Microsoft-Security-Essentials]" fullword ascii 
condition:
    any of them
}
