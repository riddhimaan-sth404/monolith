...
rule APT_Area1_SSF_GoogleSend_Strings {
   ...
   strings:
      $conf = "RefreshToken.ini" ascii 
      $client_id = "Enter your client ID here" ascii 
      $client_secret = "Enter your client secret here" ascii 
      $status = "We are going to send" ascii 
