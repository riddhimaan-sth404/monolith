...
rule MAL_RANSOM_Ragna_Locker_Apr20_1 {
   ...
   strings:
      ...
      $s1 = "bootfont.bin" ascii fullword
...
rule MAL_Ransom_Ragnarlocker_July_2020_1 {
   ...
   strings:
      $f1 = "bootfont.bin" fullword ascii 
      $f2 = "bootmgr.efi" fullword ascii 
      $f3 = "bootsect.bak" fullword ascii 
      $r1 = "$!.txt" fullword ascii 
      ...
      $a2 = "\\\\.\\PHYSICALDRIVE%d" fullword ascii /* parse disks */
      $a3 = "WinSta0\\Default" fullword ascii /* Token ref */
      $a4 = "%s-%s-%s-%s-%s" fullword ascii /* GUID parser*/
      $a5 = "SOFTWARE\\Microsoft\\Cryptography" fullword ascii /* Ref crypto used */
      $c1 = "-backup" fullword ascii 
      $c2 = "-force" fullword ascii 
      $c3 = "-vmback" fullword ascii 
      $c4 = "-list" fullword ascii 
      $s1 = ".ragn@r_" ascii /* ref */
      $s2 = "\\notepad.exe" ascii /* Show ransom note to the victim*/
      $s3 = "Opera Software" fullword ascii /* Don't touch browsers for contact him*/
      $s4 = "Tor browser" fullword ascii /*Ref ransom note*/
condition:
    any of them
}