...
rule HiddenCobra_BANKSHOT_Gen {
   ...
   strings:
      $s1 = "Mozilla/4.0 (compatible; MSIE 8.0; Win32)" fullword ascii 
      $s2 = "rHTTP/1.1 200 Connection established" fullword ascii 
      $s3 = "Proxy-Connection: keep-alive" fullword ascii 
      $s4 = "\\msncf.dat" ascii 
      ...
      $s12 = "CS*.tmp" fullword ascii 
      $s13 = "WM*.tmp" fullword ascii 
