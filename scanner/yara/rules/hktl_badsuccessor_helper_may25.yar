...
rule HKTL_EXPL_WIN_PS1_BadSuccessor_May25 {
   ...
   strings:
      $x1 = "function Get-BadSuccessorOUPermissions" ascii 
      $x2 = "\"0feb936f-47b3-49f2-9386-1dedc2c23765\"=\"msDS-DelegatedManagedServiceAccount\"" ascii
      $x3 = "CreateChild|GenericAll|WriteDACL|WriteOwner" ascii 
condition:
    any of them
}
