...
rule APT_Thrip_Sample_Jun18_2 {
   ...
   strings:
      ...
      $s2 = "ProbeScriptFint" fullword ascii 
...
rule APT_Thrip_Sample_Jun18_13 {
   ...
   strings:
      ...
      $s4 = "SOFTWARE\\QKitTORSPY" fullword ascii 
...
rule APT_Thrip_Sample_Jun18_17 {
   ...
   strings:
      ...
      $s1 = "\\DosDevices\\Pnpkb" ascii 
      $s2 = "\\DosDevices\\PnpKb" ascii 
      $s3 = "\\Driver\\kbdhid" ascii 
      $s4 = "\\Device\\PnpKb" ascii 
      $s5 = "Microsoft  Windows Operating System" fullword ascii 
