...
rule Neuron_common_strings {
    ...
    strings:
        ...
        $strReqParameter_1 = "cadataKey" ascii 
        /* $strReqParameter_2 = "cid" ascii */ /* disabled due to performance reasons */
        $strReqParameter_3 = "cadata" ascii 
        $strReqParameter_4 = "cadataSig" ascii 
        ...
        $strDefaultKey = "8d963325-01b8-4671-8e82-d0904275ab06" ascii 
        $strIdentifier = "MSXEWS" ascii 
        $strListenEndpoint = "443/ews/exchange/" ascii 
        $strB64RegKeySubstring = "U09GVFdBUkVcTWljcm9zb2Z0XENyeXB0b2dyYXBo" ascii 
