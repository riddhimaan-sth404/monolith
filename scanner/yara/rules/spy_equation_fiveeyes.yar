...
rule apt_equation_exploitlib_mutexes {
    ...
    strings:
        $a1="prkMtx" ascii 
        $a2="cnFormSyncExFBC" ascii 
        $a3="cnFormVoidFBC" ascii 
        $a4="cnFormSyncExFBC"
        $a5="cnFormVoidFBC"
condition:
...
rule Equation_Kaspersky_TripleFantasy_1 {
	...
	strings:
		$s0 = "%SystemRoot%\\system32\\hnetcfg.dll" fullword ascii 
		$s1 = "%WINDIR%\\System32\\ahlhcib.dll" fullword ascii 
		$s2 = "%WINDIR%\\sjyntmv.dat" fullword ascii 
		$s3 = "Global\\{8c38e4f3-591f-91cf-06a6-67b84d8a0102}" fullword ascii 
		$s4 = "%WINDIR%\\System32\\owrwbsdi" fullword ascii 
		$s5 = "Chrome" fullword ascii 
		$s6 = "StringIndex" fullword ascii

		$x1 = "itemagic.net@443" fullword ascii 
		$x2 = "team4heat.net@443" fullword ascii 
		$x5 = "62.216.152.69@443" fullword ascii 
		$x6 = "84.233.205.37@443" fullword ascii 

		$z1 = "www.microsoft.com@80" fullword ascii 
		$z2 = "www.google.com@80" fullword ascii 
		$z3 = "127.0.0.1:3128" fullword ascii 
condition:
    any of them
}
...
rule Equation_Kaspersky_GROK_Keylogger {
	...
	strings:
		...
		$z2 = "\\registry\\machine\\software\\Microsoft\\Windows NT\\CurrentVersion" ascii 
		$z4 = "\\registry\\machine\\SYSTEM\\ControlSet001\\Control\\Session Manager\\Environment" ascii fullword
condition:
    any of them
}
...
rule Equation_Kaspersky_GreyFishInstaller {
	...
	strings:
		$s0 = "DOGROUND.exe" fullword ascii 
		$s1 = "Windows Configuration Services" fullword ascii 
...
rule Equation_Kaspersky_EquationDrugInstaller {
	...
	strings:
		$s0 = "\\system32\\win32k.sys" ascii 
		$s1 = "ALL_FIREWALLS" fullword ascii

		$x1 = "@prkMtx" fullword ascii 
		$x2 = "STATIC" fullword ascii 
		$x3 = "windir" fullword ascii 
		$x4 = "cnFormVoidFBC" fullword ascii 
		$x5 = "CcnFormSyncExFBC" fullword ascii 
		$x6 = "WinStaObj" fullword ascii 
		$x7 = "BINRES" fullword ascii 
condition:
    any of them
}
...
rule Equation_Kaspersky_EquationLaserInstaller {
   ...
   strings:
      ...
      $s1 = "lsasrv32.dll and lsass.exe" fullword ascii 
      ...
      $s8 = "5.2.3790.220 (srv03_gdr.040918-1552)" fullword ascii 
condition:
    any of them
}
...
rule Equation_Kaspersky_EOP_Package {
	...
	strings:
		...
		$s2 = "@STATIC" fullword ascii 
		$s3 = "$aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa" fullword ascii
		$s4 = "@prkMtx" fullword ascii 
		$s5 = "prkMtx" fullword ascii 
		$s6 = "cnFormVoidFBC" fullword ascii 
condition:
    any of them
}
...
rule Equation_Kaspersky_TripleFantasy_Loader {
	...
	strings:
		$x1 = "Original Innovations, LLC" fullword ascii 
		$x2 = "Moniter Resource Protocol" fullword ascii 
		$x3 = "ahlhcib.dll" fullword ascii 
...
rule Equation_Kaspersky_SuspiciousString {
	...
	strings:
		$s1 = "i386\\DesertWinterDriver.pdb" fullword ascii
...
rule EquationDrug_NetworkSniffer1 {
   ...
   strings:
      $s0 = "Microsoft(R) Windows (TM) Operating System" fullword ascii 
      $s1 = "\\Registry\\User\\CurrentUser\\" ascii 
      $s3 = "sys\\mstcp32.dbg" fullword ascii
      $s7 = "mstcp32.sys" fullword ascii 
      $s8 = "p32.sys" fullword ascii
      $s9 = "\\Device\\%ws_%ws" ascii 
      $s10 = "\\DosDevices\\%ws" ascii 
      $s11 = "\\Device\\%ws" ascii 
condition:
      all of them
}
...
rule EquationDrug_NetworkSniffer2 {
	...
	strings:
		$s0 = "Microsoft(R) Windows (TM) Operating System" fullword ascii 
		$s1 = "IP Transport Driver" fullword ascii 
		$s2 = "tdip.sys" fullword ascii 
		$s3 = "sys\\tdip.dbg" fullword ascii
		$s4 = "dip.sys" fullword ascii
		$s5 = "\\Device\\%ws_%ws" ascii 
		$s6 = "\\DosDevices\\%ws" ascii 
		$s7 = "\\Device\\%ws" ascii 
condition:
		all of them
}
...
rule EquationDrug_NetworkSniffer3 {
	...
	strings:
		$s0 = "Corporation. All rights reserved." fullword ascii 
		$s1 = "IP Transport Driver" fullword ascii 
		$s2 = "tdip.sys" fullword ascii 
...
rule EquationDrug_VolRec_Driver {
	...
	strings:
		$s0 = "msrstd.sys" fullword ascii 
		$s1 = "msrstd.pdb" fullword ascii
		$s2 = "msrstd driver" fullword ascii 
condition:
		all of them
}
...
rule EquationDrug_KernelRootkit {
   ...
   strings:
      ...
      $s2 = "\\Registry\\User\\CurrentUser\\" ascii 
      $s3 = "msndsrv.sys" fullword ascii 
      $s5 = "\\REGISTRY\\MACHINE\\System\\CurrentControlSet\\Control\\Windows" ascii 
      $s6 = "\\Device\\%ws_%ws" ascii 
      $s7 = "\\DosDevices\\%ws" ascii 
      $s9 = "\\Device\\%ws" ascii 
condition:
      all of them
}
...
rule EquationDrug_Keylogger {
	...
	strings:
		$s0 = "\\registry\\machine\\software\\Microsoft\\Windows NT\\CurrentVersion" ascii 
		$s2 = "\\registry\\machine\\SYSTEM\\ControlSet001\\Control\\Session Manager\\En" ascii 
		$s3 = "\\DosDevices\\Gk" ascii 
		$s5 = "\\Device\\Gk0" ascii 
condition:
		all of them
}
...
rule EquationDrug_NetworkSniffer4 {
   ...
   strings:
      $s0 = "Copyright 1999 RAVISENT Technologies Inc." fullword ascii 
      $s1 = "\\systemroot\\" ascii
      $s2 = "RAVISENT Technologies Inc." fullword ascii 
      $s3 = "Created by VIONA Development" fullword ascii 
      $s4 = "\\Registry\\User\\CurrentUser\\" ascii 
      $s5 = "\\device\\harddiskvolume" ascii 
      $s7 = "ATMDKDRV.SYS" fullword ascii 
      $s8 = "\\Device\\%ws_%ws" ascii 
      $s9 = "\\DosDevices\\%ws" ascii 
      $s10 = "CineMaster C 1.1 WDM Main Driver" fullword ascii 
      $s11 = "\\Device\\%ws" ascii 
      $s13 = "CineMaster C 1.1 WDM" fullword ascii 
condition:
      all of them
}
...
rule EquationDrug_PlatformOrchestrator {
	...
	strings:
		$s0 = "SERVICES.EXE" fullword ascii 
		$s1 = "\\command.com" ascii 
		$s2 = "Microsoft(R) Windows (TM) Operating System" fullword ascii 
		$s3 = "LSASS.EXE" fullword ascii 
		$s4 = "Windows Configuration Services" fullword ascii 
...
rule EquationDrug_NetworkSniffer5 {
   ...
   strings:
      $s0 = "Microsoft(R) Windows (TM) Operating System" fullword ascii 
      $s1 = "\\Registry\\User\\CurrentUser\\" ascii 
      $s2 = "atmdkdrv.sys" fullword ascii 
      $s4 = "\\Device\\%ws_%ws" ascii 
      $s5 = "\\DosDevices\\%ws" ascii 
      $s6 = "\\Device\\%ws" ascii 
condition:
      all of them
}
...
rule EquationDrug_FileSystem_Filter {
	...
	strings:
		$s0 = "volrec.sys" fullword ascii 
		$s1 = "volrec.pdb" fullword ascii
		$s2 = "Volume recognizer driver" fullword ascii 
condition:
		all of them
}
