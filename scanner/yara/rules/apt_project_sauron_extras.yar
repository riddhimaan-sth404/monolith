...
rule APT_Project_Sauron_Custom_M1 {
	...
	strings:
		$s1 = "ncnfloc.dll" fullword ascii 
		$s4 = "Network Configuration Locator" fullword ascii 
...
rule APT_Project_Sauron_Custom_M4 {
	...
	strings:
		$s1 = "xpsmngr.dll" fullword ascii 
		$s2 = "XPS Manager" fullword ascii 
...
rule APT_Project_Sauron_Custom_M6 {
	...
	strings:
		$s1 = "rseceng.dll" fullword ascii 
		$s2 = "Remote Security Engine" fullword ascii 
...
rule APT_Project_Sauron_Custom_M7 {
	...
	strings:
		$sx1 = "Default user" fullword ascii 
		$sx2 = "Hincorrect header check" fullword ascii /* Typo */

		$sa1 = "MSAOSSPC.dll" fullword ascii
		$sa2 = "MSAOSSPC.DLL" fullword ascii 
		$sa3 = "MSAOSSPC" fullword ascii 
		$sa4 = "AOL Security Package" fullword ascii 
		$sa5 = "AOL Security Package" fullword ascii 
		$sa6 = "AOL Client for 32 bit platforms" fullword ascii 
