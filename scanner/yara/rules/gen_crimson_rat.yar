...
rule CrimsonRAT_Mar18_1 {
   ...
   strings:
      $x1 = "SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Run|" ascii 
      $x2 = "\\Release\\RTLBot.pdb" ascii
      $x3 = "cmd.exe/c systeminfo >> 1.txt" fullword ascii 
      $x4 = "/online >> Get online target with important info" fullword ascii 
      $x5 = "/screen >> ScreenShot from target PC" fullword ascii 
      $x6 = "/restart >> Restart Target PC" fullword ascii 
      $x7 = "/log_key >> Get log key file" fullword ascii 
      ...
      $fp1 = "Copyright Software Secure" ascii 
condition:
    any of them
}
