...
rule EquationGroup_watcher_linux_i386_v_3_3_0 {
   ...
   strings:
      ...
      $s9 = "89:z89:%r%opw" fullword ascii 
      $s13 = "Ropopoprstuvwypypop" fullword ascii 
...
rule EquationGroup_Toolset_Apr17_yak {
   ...
   strings:
      ...
      $x2 = "-------- driver start token -------" fullword ascii 
      $x3 = "-------- keystart token -------" fullword ascii 
...
rule EquationGroup_Toolset_Apr17_AdUser_Implant {
   ...
   strings:
      ...
      $s2 = "(&(objectCategory=person)(objectClass=user)(cn=" fullword ascii 
condition:
    any of them
}
...
rule EquationGroup_Toolset_Apr17_Processes_Target {
   ...
   strings:
      ...
      $s3 = "\\\\%ls\\root\\cimv2" fullword ascii 
      $s5 = "%4ls%2ls%2ls%2ls%2ls%2ls.%11l[0-9]%1l[+-]%6s" fullword ascii 
condition:
    any of them
}
...
rule EquationGroup_Toolset_Apr17_EpWrapper {
   ...
   strings:
      $x1 = "* Failed to get remote TCP socket address" fullword ascii 
      $x2 = "* Failed to get 'LPStart' export" fullword ascii 
      $s5 = "Usage: %ls <logdir> <dll_search_path> <dll_to_load_path> <socket>" fullword ascii 
condition:
    any of them
}
...
rule EquationGroup_Toolset_Apr17_RemoteExecute_Target {
   ...
   strings:
      ...
      $s2 = "\\\\%ls\\root\\cimv2" fullword ascii 
...
rule EquationGroup_Toolset_Apr17_DS_ParseLogs {
   ...
   strings:
      $x1 = "* Size (%d) of remaining capture file is too small to contain a valid header" fullword ascii 
      $x2 = "* Capture header not found at start of buffer" fullword ascii 
      $x3 = "Usage: %ws <capture_file> <results_prefix>" fullword ascii 
condition:
    any of them
}
...
rule EquationGroup_Toolset_Apr17_PC_LP {
   ...
   strings:
      $s1 = "* Failed to get connection information.  Aborting launcher!" fullword ascii 
      $s2 = "Format: <command> <target port> [lp port]" fullword ascii 
condition:
    any of them
}
...
rule EquationGroup_Toolset_Apr17_RemoteCommand_Lp {
   ...
   strings:
      $s1 = "Failure parsing command from %hs:%u: os=%u plugin=%u" fullword ascii 
      $s2 = "Unable to get TCP listen port: %08x" fullword ascii 
condition:
    any of them
}
...
rule EquationGroup_Toolset_Apr17_renamer {
   ...
   strings:
      $s1 = "FILE_NAME_CONVERSION.LOG" fullword ascii 
      $s2 = "Log file exists. You must delete it!!!" fullword ascii 
condition:
    any of them
}
...
rule EquationGroup_Toolset_Apr17_PC_Exploit {
   ...
   strings:
      $s1 = "\\\\.\\pipe\\pcheap_reuse" fullword ascii 
      $s2 = "**** FAILED TO DUPLICATE SOCKET ****" fullword ascii 
      $s3 = "**** UNABLE TO DUPLICATE SOCKET TYPE %u ****" fullword ascii 
      $s4 = "YOU CAN IGNORE ANY 'ServiceEntry returned error' messages after this..." fullword ascii 
condition:
    any of them
}
...
rule EquationGroup_Toolset_Apr17_PC_Level3_Gen {
   ...
   strings:
      ...
      $s2 = "Copyright (C) Microsoft" fullword ascii 
...
rule EquationGroup_Toolset_Apr17_GrDo_FileScanner_Implant {
   ...
   strings:
      $s1 = "system32\\winsrv.dll" fullword ascii 
...
rule EquationGroup_Toolset_Apr17_Ifconfig_Target {
   ...
   strings:
      $s1 = "SYSTEM\\CurrentControlSet\\Services\\Tcpip\\Parameters\\Interfaces\\%hs" fullword ascii 
...
rule EquationGroup_Toolset_Apr17_SendPKTrigger {
   ...
   strings:
      $x1 = "----====**** PORT KNOCK TRIGGER BEGIN ****====----" fullword ascii 
condition:
    any of them
}
...
rule EquationGroup_Toolset_Apr17_mstcp32_DXGHLP16_tdip {
   ...
   strings:
      $s1 = "\\Registry\\User\\CurrentUser\\" ascii 
      $s2 = "\\DosDevices\\%ws" ascii 
      $s3 = "\\Device\\%ws_%ws" ascii 
      $s4 = "sys\\mstcp32.dbg" fullword ascii
      $s5 = "%ws%03d%ws%wZ" fullword ascii 
      $s6 = "TCP/IP driver" fullword ascii 
condition:
    any of them
}
...
rule EquationGroup_Toolset_Apr17_DiBa_Target_BH_2000 {
   ...
   strings:
      $s2 = "0M1U1Z1p1" fullword ascii /* encoded string '3U5gZu' */
...
rule EquationGroup_Toolset_Apr17_PC_Level_Generic {
   ...
   strings:
      ...
      $s4 = "Corporation. All rights reserved." fullword ascii 
...
rule EquationGroup_Toolset_Apr17_PC_Level3_http_exe {
   ...
   strings:
      $s1 = "Copyright (C) Microsoft" fullword ascii 
...
rule EquationGroup_Toolset_Apr17_ActiveDirectory_Target {
   ...
   strings:
      $s1 = "(&(objectCategory=person)(objectClass=user)(cn=" fullword ascii 
      $s2 = "(&(objectClass=user)(objectCategory=person)" fullword ascii 
condition:
    any of them
}
...
rule EquationGroup_Toolset_Apr17_SlDecoder {
   ...
   strings:
      $x1 = "Error in conversion. SlDecoder.exe <input filename> <output filename> at command line " fullword ascii 
      $x2 = "KeyLogger_Data" fullword ascii 
condition:
    any of them
}
...
rule EquationGroup_Toolset_Apr17__vtuner_vtuner_1 {
   ...
   strings:
      $s1 = "Unable to get -w hash.  %x" fullword ascii 
      $s2 = "!\"invalid instruction mnemonic constant Id3vil\"" fullword ascii
      $s4 = "Unable to set -w provider. %x" fullword ascii 
...
rule EquationGroup_Toolset_Apr17__SendCFTrigger_SendPKTrigger_6 {
   ...
   strings:
      $s4 = "* Failed to connect to destination - %u" fullword ascii 
      $s6 = "* Failed to convert destination address into sockaddr_storage values" fullword ascii 
condition:
    any of them
}
...
rule EquationGroup_Toolset_Apr17__LSADUMP_Lp_ModifyPrivilege_Lp_PacketScan_Lp_put_Lp_RemoteExecute_Lp_Windows_Lp_wmi_Lp_9 {
   ...
   strings:
      $x1 = "Injection Lib -  " ascii 
      $x2 = "LSADUMP - - ERROR" ascii 
condition:
    any of them
}
