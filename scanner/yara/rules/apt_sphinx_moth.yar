...
rule Sphinx_Moth_cudacrt { 
    ...
    strings:
        $s0 = "HPSSOEx.dll" fullword ascii 
        $s1 = "255.255.255.254" fullword ascii 
        $s2 = "SOFTWARE\\SsoAuth\\Service" fullword ascii 
...
rule Sphinx_Moth_kerberos32 {
    ...
    strings:
        ...
        $x3 = "kerberos32.dll" fullword ascii 
