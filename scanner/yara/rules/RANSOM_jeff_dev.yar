rule jeff_dev_ransomware {
   ...
   strings:
      ...
      $s1 = "C:\\Users\\Umut\\Desktop\\takemeon" fullword ascii 
      $s2 = "C:\\Users\\Umut\\Desktop\\" fullword ascii
      $s3 = "PRESS HERE TO STOP THIS CREEPY SOUND AND VIEW WHAT HAPPENED TO YOUR COMPUTER" fullword ascii 
      $s4 = "WHAT YOU DO TO MY COMPUTER??!??!!!" fullword ascii 
