...
rule APT34_Malware_Exeruner {
   ...
   strings:
      ...
      $x2 = "\"wscript.shell`\")`nShell0.run" ascii
      $x3 = "powershell.exe -exec bypass -enc \" + ${global:$http_ag} +" ascii
      $x4 = "/c powershell -exec bypass -window hidden -nologo -command " fullword ascii 
      $x5 = "\\UpdateTasks\\JavaUpdatesTasksHosts\\" ascii 
      $x6 = "schtasks /create /F /ru SYSTEM /sc minute /mo 1 /tn" ascii 
      $x7 = "UpdateChecker.ps1 & ping 127.0.0.1" ascii 
      $s8 = "exeruner.exe" fullword ascii 
      $s9 = "${global:$address1} = $env:ProgramData + \"\\Windows\\Microsoft\\java\";" fullword ascii
      $s10 = "C:\\ProgramData\\Windows\\Microsoft\\java" fullword ascii 
      $s11 = "function runByVBS" fullword ascii 
      $s12 = "$84e31856-683b-41c0-81dd-a02d8b795026" fullword ascii
      $s13 = "${global:$dns_ag} = \"aQBmACAAKAAoAEcAZQB0AC0AVwBtAGk" ascii
condition:
    any of them
}