...
rule IronPanda_Malware1 {
	...
	strings:
		$x1 = "activedsimp.dll" fullword ascii 
...
rule IronPanda_Malware3 {
	...
	strings:
		$s0 = "PluginDeflater.exe" fullword ascii 
		$s1 = ".Deflated" fullword ascii 
...
rule IronPanda_Malware4 {
	...
	strings:
		$s0 = "TestPlugin.dll" fullword ascii 
		$s1 = "<a href='http://www.baidu.com'>aasd</a>" fullword ascii 
