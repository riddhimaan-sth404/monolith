...
rule Gen_Net_LocalGroup_Administrators_Add_Command {
   ...
   strings:
      $x1 = /net localgroup administrators [a-zA-Z0-9]{1,16} \/add/ ascii
condition:
    any of them
}
...
rule Suspicious_Script_Running_from_HTTP {
   ...
   strings:
      $s1 = "cmd /C script:http://" ascii 
      $s2 = "cmd /C script:https://" ascii 
      $s3 = "cmd.exe /C script:http://" ascii 
      $s4 = "cmd.exe /C script:https://" ascii 
condition:
      1 of them
}
...
rule SUSP_Microsoft_Copyright_String_Anomaly_2 {
   ...
   strings:
      $s1 = "Microsoft(C) Windows(C) Operating System" fullword ascii 
condition:
    any of them
}
...
rule SUSP_LNK_File_AppData_Roaming {
   ...
   strings:
      $s2 = "AppData" fullword ascii 
      $s3 = "Roaming" fullword ascii 
      /* .exe\x00C:\Users\ */
...
rule SUSP_PowerShell_IEX_Download_Combo {
   ...
   strings:
      $x1 = "IEX ((new-object net.webclient).download" ascii 
...
rule SUSP_Modified_SystemExeFileName_in_File {
   ...
   strings:
      $s1 = "svchosts.exe" fullword ascii 
condition:
    any of them
}
...
rule SUSP_DropperBackdoor_Keywords {
   ...
   strings:
      $x4 = "DropperBackdoor" fullword ascii
condition:
    any of them
}
...
rule SUSP_Disable_ETW_Jun20_1 {
   ...
   strings:
      $x1 = "set COMPlus_ETWEnabled=0" ascii fullword
      $x2 = "$env:COMPlus_ETWEnabled=0" ascii fullword

      $s1 = "Software\\Microsoft.NETFramework" ascii 
      $sa1 = "/v ETWEnabled" ascii fullword 
      $sa2 = " /d 0" ascii 
      $sb4 = "-Name ETWEnabled"
      $sb5 = " -Value 0 "
condition:
...
rule SUSP_PE_Discord_Attachment_Oct21_1 {
   ...
   strings:
      $x1 = "https://cdn.discordapp.com/attachments/" ascii 
condition:
    any of them
}
...
rule SUSP_Encoded_Discord_Attachment_Oct21_1 {
   ...
   strings:
      /*  encoded forms */
      $enc_b01 = "Y2RuLmRpc2NvcmRhcHAuY29tL2F0dGFjaG1lbnRz" ascii 
      $enc_b02 = "Nkbi5kaXNjb3JkYXBwLmNvbS9hdHRhY2htZW50c" ascii 
      $enc_b03 = "jZG4uZGlzY29yZGFwcC5jb20vYXR0YWNobWVudH" ascii 
      $enc_b04 = "AGMAZABuAC4AZABpAHMAYwBvAHIAZABhAHAAcAAuAGMAbwBtAC8AYQB0AHQAYQBjAGgAbQBlAG4AdABz" ascii 
      $enc_b05 = "BjAGQAbgAuAGQAaQBzAGMAbwByAGQAYQBwAHAALgBjAG8AbQAvAGEAdAB0AGEAYwBoAG0AZQBuAHQAc" ascii 
      $enc_b06 = "AYwBkAG4ALgBkAGkAcwBjAG8AcgBkAGEAcABwAC4AYwBvAG0ALwBhAHQAdABhAGMAaABtAGUAbgB0AH" ascii 

      /* hex encoded forms */
      $enc_h01 = "63646E2E646973636F72646170702E636F6D2F6174746163686D656E7473" ascii 
      $enc_h02 = "63646e2e646973636f72646170702e636f6d2f6174746163686d656e7473" ascii 

      /* reversed string */
      $enc_r01 = "stnemhcatta/moc.ppadrocsid.ndc" ascii 
condition:
    any of them
}
