...
rule OilRig_Malware_Campaign_Mal2 {
   ...
   strings:
      ...
      $x3 = "mailto:Mohammed.sarah@gratner.com" fullword ascii 
      $x4 = "mailto:Tarik.Imam@gartner.com" fullword ascii 
      $x5 = "Call Extract(DnsPs1, wss.ExpandEnvironmentStrings(\"%PUBLIC%\") & \"\\Libraries\\dns.ps1\")" fullword ascii
      $x6 = "2dy53My5vcmcvMjAw" fullword ascii /* base64 encoded string 'w.w3.org/200' */
condition:
    any of them
}
...
rule Oilrig_IntelSecurityManager_macro {
   ...
   strings:
      $one1 = "$c$m$$d$.$$" ascii 
      $one2 = "$C$$e$r$$t$u$$t$i$$l$" ascii 
      $one3 = "$$%$a$$p$p$$d$a$" ascii 
      $one4 = ".$t$$x$t$$" ascii 
      $one5 = "cu = Replace(cu, \"$\", \"\")" ascii
      $one6 = "Shell Environ$(\"COMSPEC\") & \" /c"
      $one7 = "echo \" & Chr(32) & cmd & Chr(32) & \" > \" & Chr(34)" ascii

      $two1 = "& SchTasks /Delete /F /TN " ascii 
      $two2 = "SecurityAssist" ascii 
      $two3 = "vbs = \"cmd.exe /c SchTasks" ascii
      $two4 = "/Delete /F /TN Conhost & del" ascii 
      $two5 = "NullRefrencedException" ascii 
      $two6 = "error has occurred in user32.dll by" ascii 
      $two7 = "NullRefrencedException" ascii 
condition:
    any of them
}
...
rule Oilrig_IntelSecurityManager {
   meta:
      ...
      id = "4cccc0df-a225-5500-be55-f4ae346e066e"
   strings:
      $one1 = "srvResesponded" ascii fullword
      $one2 = "InetlSecurityAssistManager" ascii fullword
      $one3 = "srvCheckresponded" ascii fullword
      $one4 = "IntelSecurityManager" ascii 
      $one5 = "msoffice365cdn.com" ascii 
      $one6 = "\\tmpCa.vbs" ascii 
      $one7 = "AAZFinish" ascii fullword
      $one8 = "AAZUploaded" ascii fullword
      $one9 = "ABZFinish" ascii fullword
      $one10 = "\\tmpCa.vbs" ascii 
condition:
    any of them
}
