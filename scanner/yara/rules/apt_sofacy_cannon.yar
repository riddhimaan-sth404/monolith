...
rule APT_APT28_Cannon_Trojan_Nov18_1 {
   ...
   strings:
      ...
      $x3 = "C:\\Users\\Public\\Music\\s.txt" fullword ascii 

      $s1 = "C:\\Documents and Settings\\All Users\\Documents" fullword ascii 
      $s2 = "notEncoded - Value here is never used" fullword ascii 
      $s3 = "Windows NT\\CurrentVersion\\Winlogon\"" fullword ascii
