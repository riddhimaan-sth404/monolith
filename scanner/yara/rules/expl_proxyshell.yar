rule EXPL_Exchange_ProxyShell_Failed_Aug21_1 {
   meta:
...
rule EXPL_Exchange_ProxyShell_Successful_Aug21_1 {
   meta:
...
rule WEBSHELL_ASPX_ProxyShell_Sep21_1 {
   meta:
      description = "Detects webshells dropped by ProxyShell exploitation based on their file header (must be PST) and  decoded request"
...
rule SUSP_IIS_Config_VirtualDir {
   ...
   strings:
      ...
      $fp1 = "Microsoft.Web.Administration" ascii 
...
rule WEBSHELL_ProxyShell_Exploitation_Nov21_1 {
   ...
   strings:
      $s01 = ".LoadXml(System.Text.Encoding.UTF8.GetString(System.Convert.FromBase64String(Request[" ascii 
      $s02 = "new System.IO.MemoryStream()" ascii 
      $s03 = "Transform(" ascii 
condition:
      all of ($s*)
}
