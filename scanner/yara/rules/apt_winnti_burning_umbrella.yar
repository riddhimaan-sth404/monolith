...
rule MAL_BurningUmbrella_Sample_4 {
   ...
   strings:
      ...
      $x6 = "Micrsoft Corporation. All rights reserved." fullword ascii 
...
rule MAL_BurningUmbrella_Sample_20 {
   ...
   strings:
      $s1 = "Wordpad.Document.1\\shell\\open\\command\\" ascii 
      $s2 = "%s\\shell\\Open\\command" fullword ascii 
...
rule MAL_Winnti_Sample_May18_1 {
   ...
   strings:
      $s1 = "wireshark" fullword ascii 
      $s2 = "procexp" fullword ascii 
condition:
    any of them
}
