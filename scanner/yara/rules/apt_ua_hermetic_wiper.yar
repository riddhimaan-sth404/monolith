...
rule APT_UA_Hermetic_Wiper_Feb22_1 {
   ...
   strings:
      ...
      $s1 = "\\\\?\\C:\\Windows\\System32\\winevt\\Logs" ascii fullword
      $s2 = "\\\\.\\EPMNTDRV\\%u" ascii fullword
      $s3 = "DRV_XP_X64" ascii fullword
      $s4 = "%ws%.2ws" ascii fullword
...
rule APT_UA_Hermetic_Wiper_Artefacts_Feb22_1 {
   ...
   strings:
      $sx1 = "/c powershell -c \"rundll32 C:\\windows\\system32\\comsvcs.dll MiniDump" ascii
      $sx2 = "appdata\\local\\microsoft\\windows\\winupd.log" ascii 
      $sx3 = "AppData\\Local\\Microsoft\\Windows\\Winupd.log" ascii 
      $sx4 = "CSIDL_SYSTEM_DRIVE\\temp\\sys.tmp1" ascii 
      $sx5 = "\\policydefinitions\\postgresql.exe" ascii 

      $sx6 = "powershell -v 2 -exec bypass -File text.ps1" ascii 
      $sx7 = "powershell -exec bypass gp.ps1" ascii 
      $sx8 = "powershell -exec bypass -File link.ps1" ascii 

      /* 16 is the prefix of an epoch timestamp that shouldn't change until the 14th of November 2023 */
      $sx9 = " 1> \\\\127.0.0.1\\ADMIN$\\__16" ascii 
      
      $sa1 = "(New-Object System.Net.WebClient).DownloadFile(" ascii 
      $sa2 = "CSIDL_SYSTEM_DRIVE\\temp\\" ascii 
      $sa3 = "1> \\\\127.0.0.1\\ADMIN$" ascii 
...
rule APT_UA_Hermetic_Wiper_Scheduled_Task_Feb22_1 {
   ...
   strings:
      $a0 = "<Task version=" ascii 

      $sa1 = "CSIDL_SYSTEM_DRIVE\\temp" ascii 
      $sa2 = "postgresql.exe 1> \\\\127.0.0.1\\ADMIN$" ascii 
      $sa3 = "cmd.exe /Q /c move CSIDL_SYSTEM_DRIVE" ascii 
condition:
      $a0 and 1 of ($s*)
}
