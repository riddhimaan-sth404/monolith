...
rule TidePool_Malware {
	...
	strings:
		...
		$x2 = "C:\\PROGRA~2\\IEHelper\\mshtml.dll" fullword ascii 
		$x3 = "C:\\DOCUME~1\\ALLUSE~1\\IEHelper\\mshtml.dll" fullword ascii 
		$x4 = "IEComDll.dat" fullword ascii

		$s1 = "Content-Type: multipart/form-data; boundary=----=_Part_%x" fullword ascii 
