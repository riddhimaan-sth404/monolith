rule MAL_CRIME_suspicious_hex_string_Jun21_1 {
    meta:
        author = "Nils Kuhnert"
        date = "2021-06-04"
...
rule MAL_CRIME_Unknown_LNK_Jun21_1 {
    meta:
        author = "Nils Kuhnert"
        date = "2021-06-04"
    ...
    strings:
        $uid = "S-1-5-21-1437133880-1006698037-385855442-1004" ascii 
condition:
        uint16(0) == 0x004c and all of them
}

rule MAL_CRIME_Unknown_ISO_Jun21_1 {
    meta:
        author = "Nils Kuhnert"
        date = "2021-06-04"
