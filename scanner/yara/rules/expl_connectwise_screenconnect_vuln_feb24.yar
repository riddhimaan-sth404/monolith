...
rule SUSP_ScreenConnect_Exploitation_Artefacts_Feb24 {
   meta:
   ...
   strings:
      ...
      $x20 = "::size -eq 4){\\\"TVqQAA" ascii
      $x21 = "::size -eq 4){\"TVqQAA" ascii
...
rule SUSP_Command_Line_Combos_Feb24_2 {
   meta:
...
rule SUSP_PS1_Combo_TransferSH_Feb24 {
   meta:
...
rule MAL_MSI_Mpyutils_Feb24_1 {
   ...
   strings:
      ...
      $s2 = "EXPAND.EXE" ascii fullword
      $s6 = "ICACLS.EXE" ascii fullword
condition:
    any of them
}
