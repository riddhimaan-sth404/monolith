rule xDedic_SysScan_unpacked {
   ...
   strings:
      $a1 = "/c ping -n 2 127.0.0.1 & del \"SysScan.exe\"" ascii
      $a2 = "SysScan DEBUG Mode!!!" ascii 
      $a3 = "This rechecking? (set 0/1 or press enter key)" ascii 
      $a4 = "http://37.49.224.144:8189/manual_result" ascii 

      $b1 = "Checker end work!" ascii 
      $b2 = "Trying send result..." ascii 
condition:
    any of them
}
