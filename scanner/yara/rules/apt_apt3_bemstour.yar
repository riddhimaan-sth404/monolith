...
$dbg_print_1 = "leaked address is 0x%llx" ascii 
$dbg_print_2 = "========== %s ==========" ascii 
$dbg_print_3 = "detailVersion:%d" ascii 
$dbg_print_4 = "create pipe twice failed" ascii 
$dbg_print_5 = "WSAStartup function failed with error: %d" ascii 
$dbg_print_6 = "can't open input file." ascii 
$dbg_print_7 = "Allocate Buffer Failed." ascii 
$dbg_print_8 = "Connect to target failed." ascii 
$dbg_print_9 = "connect successful." ascii 
$dbg_print_10 = "not supported Platform" ascii 
$dbg_print_11 = "Wait several seconds." ascii 
$dbg_print_12 = "not set where to write ListEntry ." ascii 
$dbg_print_13 = "backdoor not installed." ascii 
$dbg_print_14 = "REConnect to target failed." ascii 
$dbg_print_15 = "Construct TreeConnectAndX Request Failed." ascii 
$dbg_print_16 = "Construct NTCreateAndXRequest  Failed." ascii 
$dbg_print_17 = "Construct Trans2  Failed." ascii 
$dbg_print_18 = "Construct ConsWXR  Failed." ascii 
$dbg_print_19 = "Construct ConsTransSecondary  Failed." ascii 
$dbg_print_20 = "if you don't want to input password , use server2003 version.." ascii 

$cmdline_1 = "Command format  %s TargetIp domainname username password 2" ascii 
$cmdline_2 = "Command format  %s TargetIp domainname username password 1" ascii 
$cmdline_3 = "cmd.exe /c net user test test /add && cmd.exe /c net localgroup administrators test /add" ascii 
$cmdline_4 = "hello.exe  \"C:\\WINDOWS\\DEBUG\\test.exe\"" ascii
$cmdline_5 = "parameter not right" ascii 

$smb_param_1 = "browser" ascii 
$smb_param_2 = "spoolss" ascii 
$smb_param_3 = "srvsvc" ascii 
$smb_param_4 = "\\PIPE\\LANMAN" ascii 
$smb_param_5 = "Werttys for Workgroups 3.1a" ascii 
$smb_param_6 = "PC NETWORK PROGRAM 1.0" ascii 
$smb_param_7 = "LANMAN1.0" ascii 
$smb_param_8 = "LM1.2X002" ascii 
$smb_param_9 = "LANMAN2.1" ascii 
$smb_param_10 = "NT LM 0.12" ascii 
$smb_param_12 = "WORKGROUP" ascii 
$smb_param_13 = "Windows Server 2003 3790 Service Pack 2" ascii 
$smb_param_14 = "Windows Server 2003 5.2" ascii 
$smb_param_15 = "Windows 2002 Service Pack 2 2600" ascii 
$smb_param_16 = "Windows 2002 5.1" ascii 
$smb_param_17 = "PC NETWORK PROGRAM 1.0" ascii 
$smb_param_18 = "Windows 2002 5.1" ascii 
$smb_param_19 = "Windows for Workgroups 3.1a" ascii 
