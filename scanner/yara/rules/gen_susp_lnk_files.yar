...
rule SUSP_LNK_lnkfileoverRFC {
   ...
   strings:
      ...
      $ = "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAD" ascii //some filler, needed to work with routine
      $cert = " -decode " ascii // decoder
condition:
    any of them
}
...
rule SUSP_LNK_SuspiciousCommands {
   ...
   strings:
      ...
      /* $s6 = " bypass " ascii */
      $s7 = " -noprofile " ascii 
      $s8 = ".DownloadString(" ascii 
      $s9 = ".DownloadFile(" ascii 
      $s10 = "IEX(" ascii 
      $s11 = "iex(" ascii 
      $s12 = "WScript.shell" ascii fullword 
      $s13 = " -nop " ascii 
      $s14 = "&tasklist>"
