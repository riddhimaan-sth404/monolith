rule cryptonar_ransomware {
   ...
   strings:
      ...
      $s2 = "CryptoNarDecryptor.exe" fullword ascii 
      ...
      $s4 = "Do not delete this file, else the decryption process will be broken" fullword ascii 
      ...
      $s7 = "Decryption process failed" fullword ascii 
      ...
      $s10 = "johnsmith987654@tutanota.com" fullword ascii 
      $s11 = "Decryption process will start soon" fullword ascii 
      $s12 = "CryptoNarDecryptor.DecryptionProgressBarForm.resources" fullword ascii
      $s13 = "DecryptionProcessProgressBar" fullword ascii 
