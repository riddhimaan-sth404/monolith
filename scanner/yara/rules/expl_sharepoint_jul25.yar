...
rule WEBSHELL_ASPX_Compiled_Sharepoint_Drop_CVE_2025_53770_Jul25_2 {
   ...
   strings:
      $x1 = /App_Web_spinstall\d{0,1}.aspx/ ascii
      $x2 = /spinstall[\w]?[\._]aspx/ ascii
      $x3 = /\/_layouts\/1[0-9]\/spinstall/ ascii
      $x4 = /\/_layouts\/1[0-9]\/ghostfile/ ascii

      $s1 = "System.Web.Configuration.MachineKeySection" ascii 
      $s2 = "Page_load" ascii fullword
      $s3 = "GetApplicationConfig" ascii fullword
condition:
    any of them
}
...
rule APT_EXPL_Sharepoint_CVE_2025_53770_ForensicArtefact_Jul25_1 {
   ...
   strings:
      $sa1 = /POST \/_layouts\/1[0-9]\/ToolPane\.aspx/ ascii
      $sa2 = "DisplayMode=Edit&a=/ToolPane.aspx" ascii 

      $sb1 = /GET \/_layouts\/1[0-9]\/spinstall/ ascii // specific
      $sb2 = "/_layouts/SignOut.aspx 200" ascii 
condition:
    any of them
}
...
rule APT_EXPL_Sharepoint_CVE_2025_53770_ForensicArtefact_Jul25_2 {
   ...
   strings:
      $x1 = "-EncodedCommand JABiAGEAcwBlADYANABTAHQAcgBpAG4AZwAgAD0" ascii 
      $x2 = "TEMPLATE\\LAYOUTS\\spinstall" ascii 
      $x3 = "TEMPLATE\\LAYOUTS\\ghostfile" ascii 
      $x4 = "TEMPLATE\\LAYOUTS\\1.css" ascii 
      $x5 = "Mozilla/5.0+(Windows+NT+10.0;+Win64;+x64;+rv:120.0)+Gecko/20100101+Firefox/120.0 /_layouts/SignOut.aspx" ascii 
