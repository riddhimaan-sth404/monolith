...
rule NK_Miner_Malware_Jan18_1 {
   ...
   strings:
      ...
      $x2 = "The number of processors on this computer is {0}." fullword ascii 
      $x3 = { 00 00 1F 43 00 3A 00 5C 00 4E 00 65 00 77 00 44
              00 69 00 72 00 65 00 63 00 74 00 6F 00 72 00 79
              00 00 }
      $x4 = "Le fichier Hello txt n'existe pas" fullword ascii 
      $x5 = "C:\\NewDirectory2\\info2" fullword ascii 
      ...
      $c = "barjuok.ryongnamsan.edu.kp" ascii
      $d = "C:\\SoftwaresInstall\\soft" ascii
      $e = "C:\\Windows\\Sys64\\intelservice.exe" ascii
      $f = "C:\\Windows\\Sys64\\updater.exe" ascii
condition:
    any of them
}
