...
rule CloudDuke_Malware {
	...
	strings:
		...
		$s4 = "%ws_out%ws" fullword ascii 
		$s5 = "Akernel32.dll" fullword ascii 
...
rule SFXRAR_Acrotray {
	...
	strings:
		$s1 = "winrarsfxmappingfile.tmp" fullword ascii /* PEStudio Blacklist: strings */
		$s2 = "GETPASSWORD1" fullword ascii /* PEStudio Blacklist: strings */
		$s3 = "acrotray.exe" fullword ascii
		$s4 = "CryptUnprotectMemory failed" fullword ascii /* PEStudio Blacklist: strings */
condition:
    any of them
}
