...
rule apt_hellsing_implantstrings { 
	...
	strings: 
		...
		$c = "xweber_server.exe" 
		$d = "action="
		$debugpath1 = "d:\\Hellsing\\release\\msger\\" 
		$debugpath2 = "d:\\hellsing\\sys\\xrat\\" 
		$debugpath3 = "D:\\Hellsing\\release\\exe\\" 
		$debugpath4 = "d:\\hellsing\\sys\\xkat\\" 
		$debugpath5 = "e:\\Hellsing\\release\\clare" 
		$debugpath6 = "e:\\Hellsing\\release\\irene\\" 
		$debugpath7 = "d:\\hellsing\\sys\\irene\\" 
		$e = "msger_server.dll" 
		$f = "ServiceMain"
condition:
    any of them
...
rule apt_hellsing_installer { 
	...
	strings: 
		...
		$a9 = "C:\\Windows\\System32\\sysprep\\sysprep.exe" ascii 
		$a10 = "%SystemRoot%\\system32\\cmd.exe" ascii 
...
rule apt_hellsing_irene { 
	...
	strings: 
		$a1 = "\\Drivers\\usbmgr.tmp" ascii 
		$a2 = "\\Drivers\\usbmgr.sys" ascii 
