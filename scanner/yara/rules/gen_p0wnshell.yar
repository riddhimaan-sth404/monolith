...
rule Hacktool_Strings_p0wnedShell {
   ...
   strings:
      ...
      $fp1 = "Sentinel Labs, Inc." ascii 
      $fp2 = "Copyright Elasticsearch B.V." ascii 
...
rule p0wnedShellx64 {
   ...
   strings:
      $x1 = "Oq02AB+LCAAAAAAABADs/QkW3LiOLQBuRUsQR1H731gHMQOkFGFnvvrdp/O4sp6tkDiAIIjhAryu4z6PVOtxHuXz3/xT6X9za/Df/Hsa/JT/9Pjgb/+kPPhv9Sjp01Wf" ascii 
      $x2 = "Invoke-TokenManipulation" ascii 
      $x3 = "-CreateProcess \"cmd.exe\" -Username \"nt authority\\system\"" fullword ascii
      $x4 = "CommandShell with Local Administrator privileges :)" fullword ascii 
      $x5 = "Invoke-shellcode -Payload windows/meterpreter/reverse_https -Lhost " fullword ascii 

      $fp1 = "AVSignature" ascii 
condition:
...
rule p0wnedListenerConsole {
   ...
   strings:
      $x1 = "Invoke_ReflectivePEInjection" fullword ascii 
      $x5 = "p0wnedShell> " fullword ascii 
      $x6 = "Resources.Get_PassHashes" fullword ascii 
      $s7 = "Invoke_CredentialsPhish" fullword ascii 
      $s8 = "Invoke_Shellcode" fullword ascii 
      $s9 = "Resources.Invoke_TokenManipulation" fullword ascii 
      $s10 = "Resources.Port_Scan" fullword ascii 
      $s20 = "Invoke_PowerUp" fullword ascii 
condition:
      1 of them
}
