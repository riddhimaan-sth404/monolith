...
rule Sofacy_Malware_StrangeSpaces {
	...
	strings:
		$s2 = "Delete Temp Folder Service                                  " fullword ascii 
		$s3 = " Operating System                        " fullword ascii 
		$s4 = "Microsoft Corporation                                       " fullword ascii 
		$s5 = " Microsoft Corporation. All rights reserved.               " fullword ascii 
condition:
    any of them
}
...
rule Sofacy_Malware_AZZY_Backdoor_1 {
	...
	strings:
		$s0 = "advstorshell.dll" fullword ascii 
		$s1 = "advshellstore.dll" fullword ascii
		$s2 = "Windows Advanced Storage Shell Extension DLL" fullword ascii 
condition:
    any of them
}
...
rule Sofacy_CollectorStealer_Gen2 {
	...
	strings:
		...
		$s2 = "msdeltemp.dll" fullword ascii 
		$s3 = "Delete Temp Folder Service" fullword ascii 
condition:
    any of them
}
...
rule Sofacy_CollectorStealer_Gen3 {
	...
	strings:
		...
		$a1 = "%.4d%.2d%.2d%.2d%.2d%.2d%.2d%.4d" fullword ascii 
		$a2 = "IGFSRVC.dll" fullword ascii 
		$a3 = "Common User Interface" fullword ascii 
		$a4 = "igfsrvc Module" fullword ascii 

		$b1 = " Operating System                        " fullword ascii 
		$b2 = "Microsoft Corporation                                       " fullword ascii 
condition:
    any of them
}
