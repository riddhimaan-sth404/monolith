...
rule FourElementSword_T9000 {
	...
	strings:
		...
		$x2 = "%s\\temp\\HHHH.dat" fullword ascii 

		$s1 = "Elevate.dll" fullword ascii 
		$s2 = "ResN32.dll" fullword ascii 
		$s3 = "Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1; SV1)" fullword ascii 
		$s4 = "igfxtray.exe" fullword ascii 
condition:
    any of them
}
...
rule FourElementSword_fslapi_dll_gui {
	...
	strings:
		$s1 = "fslapi.dll.gui" fullword ascii 
...
rule FourElementSword_ElevateDLL {
	meta:
		...
		id = "06879d75-18a3-5d49-a963-fa4bee379387"
	strings:
		$x1 = "Elevate.dll" fullword ascii 
		$x2 = "ResN32.dll" fullword ascii 

		$s1 = "Kingsoft\\Antivirus" fullword ascii 
		$s2 = "KasperskyLab\\protected" fullword ascii 
		$s3 = "Sophos" fullword ascii 
condition:
    any of them
}
