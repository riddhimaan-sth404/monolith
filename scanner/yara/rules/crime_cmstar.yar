...
rule ce_enfal_cmstar_debug_msg {
	...
	strings:
		$d1 = "EEE\x0d\x0a" fullword ascii
		$d2 = "TKE\x0d\x0a" fullword ascii
		$d3 = "VPE\x0d\x0a" fullword ascii
		$d4 = "VPS\x0d\x0a" fullword ascii
		$d5 = "WFSE\x0d\x0a" fullword ascii
		$d6 = "WFSS\x0d\x0a" fullword ascii
		$d7 = "CM**\x0d\x0a" fullword ascii
condition:
