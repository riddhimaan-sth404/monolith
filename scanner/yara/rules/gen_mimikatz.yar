...
rule Mimikatz_Strings {
   ...
   strings:
      $x1 = "sekurlsa::logonpasswords" fullword ascii
      $x2 = "List tickets in MIT/Heimdall ccache" fullword ascii 
      $x3 = "kuhl_m_kerberos_ptt_file ; LsaCallKerberosPackage %08x" fullword ascii 
      $x4 = "* Injecting ticket :" fullword ascii
      $x5 = "mimidrv.sys" fullword ascii
      $x6 = "Lists LM & NTLM credentials" fullword ascii
      $x7 = "\\_ kerberos -" ascii
      $x8 = "* unknow   :" fullword ascii
      $x9 = "\\_ *Password replace ->" ascii
      $x10 = "KIWI_MSV1_0_PRIMARY_CREDENTIALS KO" ascii 
      $x11 = "\\\\.\\mimidrv" ascii
      $x12 = "Switch to MINIDUMP :" fullword ascii
      $x13 = "[masterkey] with password: %s (%s user)" fullword ascii 
      $x14 = "Clear screen (doesn't work with redirections, like PsExec)" fullword ascii 
      $x15 = "** Session key is NULL! It means allowtgtsessionkey is not set to 1 **" fullword ascii 
      $x16 = "[masterkey] with DPAPI_SYSTEM (machine, then user): " fullword ascii 
condition:
    any of them
}
...
rule AppInitHook {
   ...
   strings:
      ...
      $s2 = "mimikatz.exe" fullword ascii 
      $s3 = "]X86Instruction->OperandSize >= Operand->Length" fullword ascii 
      $s4 = "mhook\\disasm-lib\\disasm.c" fullword ascii 
      $s5 = "mhook\\disasm-lib\\disasm_x86.c" fullword ascii 
