...
rule Molerats_Jul17_Sample_1 {
   ...
   strings:
      ...
      $s1 = "ezExODA0Y2U0LTkzMGEtNGIwOS1iZjcwLTlmMWE5NWQwZDcwZH0sIEN1bHR1cmU9bmV1dHJhbCwgUHVibGljS2V5VG9rZW49M2U1NjM1MDY5M2Y3MzU1ZQ==,[z]{c00" ascii 
condition:
    any of them
}
...
rule Molerats_Jul17_Sample_3 {
   ...
   strings:
      $s1 = "ccleaner.exe" fullword ascii 
...
rule Molerats_Jul17_Sample_4 {
   ...
   strings:
      $x1 = "get-itemproperty -path 'HKCU:\\SOFTWARE\\Microsoft\\' -name 'KeyName')" ascii 
      $x2 = "O.Run C & chrw(34) & \"[System.IO.File]::" ascii
      $x3 = "HKCU\\SOFTWARE\\Microsoft\\\\KeyName\"" fullword ascii
condition:
    any of them
}
...
rule Molerats_Jul17_Sample_5 {
   ...
   strings:
      $x1 = "powershell.exe -nop -c \"iex" ascii
      $x2 = ".run('%windir%\\\\SysWOW64\\\\WindowsPowerShell\\\\" ascii

      $a1 = "Net.WebClient).DownloadString" ascii
      $a2 = "gist.githubusercontent.com" ascii
condition:
    any of them
}
...
rule Molerats_Jul17_Sample_Dropper {
   ...
   strings:
      $s1 = "Please remove %s from %s folder. It is unsecure to run %s until it is done." fullword ascii 
