...
rule MAL_QBot_HTML_Smuggling_Indicators_Oct22_1 {
   ...
   strings:
      /* Double  encoded - as seen in HTML */
      ...
      /* Triple  encoded - to detect the double encoded versions in email attachments */
      ...
      /* HTML */
      $htm = "<html" ascii
      /* avoid matches in emails with double encoding - because email attachments get  encoded */
