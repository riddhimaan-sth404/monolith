rule MAL_Prolock_Malware {
	...
	strings:
		...
		$DecryptedString1 = "support981723721@protonmail.com" ascii
		$DecryptedString2 = "Your files have been encrypted by ProLock Ransomware" ascii
		$DecryptedString3 = "msaoyrayohnp32tcgwcanhjouetb5k54aekgnwg7dcvtgtecpumrxpqd.onion" ascii
