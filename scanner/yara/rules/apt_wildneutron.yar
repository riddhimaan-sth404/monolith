...
rule WildNeutron_Sample_1 {
	...
	strings:
		$s0 = "LiveUpdater.exe" fullword ascii /* PEStudio Blacklist: strings */ /* score: '25.00' */
		$s1 = "id-at-postalAddress" fullword ascii /* PEStudio Blacklist: strings */ /* score: '18.00' */
		$s2 = "%d -> %d (default)" fullword ascii /* PEStudio Blacklist: strings */ /* score: '17.00' */
		$s3 = "%s%s%s=%d,%s=%d,%s=%d," fullword ascii /* score: '15.00' */
		$s8 = "id-ce-keyUsage" fullword ascii /* score: '12.00' */
		$s9 = "Key Usage" fullword ascii /* score: '12.00' */
		$s32 = "UPDATE_ID" fullword ascii /* PEStudio Blacklist: strings */ /* score: '9.00' */
		$s37 = "id-at-commonName" fullword ascii /* score: '8.00' */
		$s38 = "2008R2" fullword ascii /* PEStudio Blacklist: os */ /* score: '8.00' */
		$s39 = "RSA-alt" fullword ascii /* PEStudio Blacklist: strings */ /* score: '8.00' */
		$s40 = "%02d.%04d.%s" fullword ascii /* score: '7.02' */
condition:
    any of them
}
...
rule WildNeutron_Sample_2 {
	...
	strings:
		$s0 = "rundll32.exe \"%s\",#1" fullword ascii /* PEStudio Blacklist: strings */ /* score: '33.00' */
		$s1 = "IgfxUpt.exe" fullword ascii /* score: '20.00' */
		$s2 = "id-at-postalAddress" fullword ascii /* PEStudio Blacklist: strings */ /* score: '18.00' */
		$s3 = "Intel(R) Common User Interface" fullword ascii /* PEStudio Blacklist: strings */ /* score: '17.00' */
		$s4 = "%s%s%s=%d,%s=%d,%s=%d," fullword ascii /* score: '15.00' */
		$s11 = "Key Usage" fullword ascii /* score: '12.00' */
		$s12 = "Intel Integrated Graphics Updater" fullword ascii /* PEStudio Blacklist: strings */ /* score: '12.00' */
...
rule WildNeutron_Sample_3 {
	...
	strings:
		...
		$x2 = "\"http://fw.ddosprotected.eu:80 /opts resolv=drfx.chickenkiller.com\"" fullword ascii /* PEStudio Blacklist: strings */ /* score: '33.00' */

		$s1 = "LiveUpdater.exe" fullword ascii /* PEStudio Blacklist: strings */ /* score: '25.00' */
		$s2 = "id-at-postalAddress" fullword ascii /* PEStudio Blacklist: strings */ /* score: '18.00' */
		$s3 = "%d -> %d (default)" fullword ascii /* PEStudio Blacklist: strings */ /* score: '17.00' */
		$s4 = "%s%s%s=%d,%s=%d,%s=%d," fullword ascii /* score: '15.00' */
		...
		$s7 = "Acer LiveUpdater" fullword ascii /* PEStudio Blacklist: strings */ /* score: '10.00' */
condition:
    any of them
}
...
rule WildNeutron_Sample_4 {
	...
	strings:
		...
		$s0 = "rundll32.exe \"%s\",#1" fullword ascii /* PEStudio Blacklist: strings */ /* score: '33.00' */
		$s1 = "RtlUpd.EXE" fullword ascii /* score: '20.00' */
		$s2 = "RtlUpd.exe" fullword ascii /* score: '20.00' */
		$s3 = "Driver Update and remove for Windows x64 or x86_32" fullword ascii /* PEStudio Blacklist: strings */ /* score: '17.00' */
		$s4 = "Realtek HD Audio Update and remove driver Tool" fullword ascii /* PEStudio Blacklist: strings */ /* score: '16.00' */
		$s5 = "%s%s%s=%d,%s=%d,%s=%d," fullword ascii /* score: '15.00' */
...
rule WildNeutron_Sample_5 {
	...
	strings:
		...
		$s9 = "%02d.%04d.%s" fullword ascii /* score: '7.02' */
condition:
    any of them
}
...
rule WildNeutron_Sample_6 {
	...
	strings:
		$s0 = "mshtaex.exe" fullword ascii /* score: '20.00' */
condition:
    any of them
}
...
rule HKTL_NativeCmd_subTee_Jul15 {
   ...
   strings:
      ...
      $x3 = "Error executing CreateProcess()!!" fullword ascii 
      $x4 = "cmdcmdline" fullword ascii 
      $x5 = "Invalid input handle!!!" fullword ascii
      $s5 = "Usage: destination [reference]" fullword ascii 
      $s6 = ".com;.exe;.bat;.cmd" ascii 
      $s15 = "%-8s %-3s  %*s %s  %s" fullword ascii 
      $s16 = " %%%c in (%s) do " fullword ascii 
condition:
...
rule WildNeutron_Sample_9 {
   ...
   strings:
      $s0 = "http://get.adobe.com/flashplayer/" ascii /* score: '30.00' */
      $s4 = " Player Installer/Uninstaller" fullword ascii /* score: '11.42' */
      $s5 = "Adobe Flash Plugin Updater" fullword ascii /* score: '11.00' */
      $s6 = "uSOFTWARE\\Adobe" fullword ascii /* score: '10.42' */
      $s11 = "2008R2" fullword ascii /* PEStudio Blacklist: os */ /* score: '8.00' */
      $s12 = "%02d.%04d.%s" fullword ascii /* score: '7.02' */
      $s13 = "%d -> %d" fullword ascii /* score: '7.00' */
condition:
    any of them
}
...
rule WildNeutron_Sample_10 {
	...
	strings:
		...
		$x5 = "mshtaex.exe" fullword ascii /* score: '20.00' */
...
rule APT_MAL_WildNeutron_javacpl {
   ...
   strings:
      ...
      $s2 = "cmdcmdline" ascii fullword
      $s3 = "\"%s\" /K %s" ascii fullword
      $s4 = "Process is not running any more" ascii fullword
      $s5 = "dpnxfsatz" ascii fullword
