...
rule syskit {
   ...
   strings:
      $x1 = "timeout /t 10 & sc stop dllhost & timeout /t 10 & del C:\\Windows\\Temp\\BAK.exe" fullword ascii 
      ...
      $s3 = "C:\\Windows\\Temp\\rconfig.xml" fullword ascii 
      $s4 = "Add-Type -AssemblyName System.IO.Compression.FileSystem" fullword ascii 
      $s5 = "serviceProcessInstaller1" fullword ascii
      $s6 = "    [System.IO.Compression.ZipFile]::ExtractToDirectory($zipfile, $outpath)" fullword ascii 
      $s7 = "exec_cmd2" fullword ascii
      $s8 = "exec_cmd" fullword ascii
      $s9 = "send_command_result" fullword ascii
      $s10 = "mycontent" fullword ascii
      $s11 = "Diagnostic Server Host" fullword ascii 
