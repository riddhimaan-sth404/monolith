...
rule APT_HKTL_Wiper_WhisperGate_Jan22_2 {
   ...
   strings:
      ...
      $s1 = "xownxloxadDxatxxax" ascii 
      $s2 = "0AUwBsAGUAZQBwACAALQBzACAAMQAwAA==" ascii /* Decoded with , UTF-16-LE: Sleep -s 10 */
      $s3 = "https://cdn.discordapp.com/attachments/" ascii 
...
rule MAL_Unknown_Discord_Characteristics_Jan22_1 {
   ...
   strings:
      $x1 = "xownxloxadDxatxxax" ascii 
      
      $s2 = "https://cdn.discordapp.com/attachments/" ascii 
condition:
    any of them
}
