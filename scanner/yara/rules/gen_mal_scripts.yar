...
rule PS_AMSI_Bypass {
   ...
   strings:
      $s1 = ".GetField('amsiContext',[Reflection.BindingFlags]'NonPublic,Static')." ascii 
condition:
      1 of them
}
...
rule Certutil_Decode_OR_Download {
   ...
   strings:
      $a1 = "certutil -decode " ascii 
      $a2 = "certutil  -decode " ascii 
      $a3 = "certutil.exe -decode " ascii 
      $a4 = "certutil.exe  -decode " ascii 
      $a5 = "certutil -urlcache -split -f http" ascii 
      $a6 = "certutil.exe -urlcache -split -f http" ascii 
