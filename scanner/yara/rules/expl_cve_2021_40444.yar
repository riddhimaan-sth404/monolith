...
rule EXPL_CVE_2021_40444_Document_Rels_XML {
   ...
   strings:
      ...
      $c1 = "Target=\"mhtml:http"
      $c2 = "!x-usc:http" 
      $c3 = "TargetMode=\"External\""
condition:
    any of them
}
...
rule SUSP_OBFUSC_Indiators_XML_OfficeDoc_Sep21_1 {
   meta:
      author = "Florian Roth (Nextron Systems)"
   ...
   strings:
      ...
      $xml_e = "Target=\"&#" ascii
      $xml_mode_1 = "TargetMode=\"&#" ascii
condition:
    any of them
}

rule SUSP_OBFUSC_Indiators_XML_OfficeDoc_Sep21_2 {
   meta:
      author = "Florian Roth (Nextron Systems)"
      description = "Detects suspicious encodings in fields used in reference files found in weaponized MS Office documents"
      reference = "https://twitter.com/sudosev/status/1439205606129377282"
