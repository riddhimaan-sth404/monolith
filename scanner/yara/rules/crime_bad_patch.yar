...
rule WinAgent_BadPatch_1 {
   ...
   strings:
      $x1 = "J:\\newPatch\\downloader\\" ascii 
      $x2 = "L:\\rashed\\New code\\" ascii 
      $x3 = ":\\newPatch\\last version\\" ascii 
      $x4 = "\\Microsoft\\Microsoft\\Microsoft1.log" ascii 
      $x5 = "\\Microsoft\\Microsoft\\Microsoft.log" ascii 
      $x6 = "\\Microsoft\\newPP.exe" ascii 
      $x7 = " (this is probably a proxy server error)." fullword ascii 
      $x8 = " :Old - update patch and check anti-virus.. " fullword ascii 
      $x9 = "PatchNotExit-- download now.. " fullword ascii 
      $x10 = "PatchNotExit-- Check Version" fullword ascii 
      $x11 = "PatchNotExit-- Version Patch" fullword ascii 

      $s1 = "downloader " fullword ascii 
      $s2 = "DelDownloadFile" fullword ascii
      $s3 = "downloadFile" fullword ascii
      $s4 = "downloadUpdate" fullword ascii 
condition:
    any of them
}
...
rule WinAgent_BadPatch_2 {
   ...
   strings:
      $s1 = "myAction=shell_result&serialNumber=" fullword ascii 
      $s2 = "\\Appdata\\Local\\Google\\Chrome\\User Data\\Default\\Login Data.*" ascii 
      $s3 = "\\AppData\\Roaming\\Mozilla\\Firefox\\Profiles" ascii 
      $s4 = "\\Appdata\\Local\\Google\\Chrome\\User Data\\Default\\Cookies.*" ascii 
      $s5 = "newSHELL[" fullword ascii 
      $s6 = "\\file1.txt" ascii 
      $s7 = "myAction=newGIF&serialNumber=" fullword ascii 
      $s8 = "\\Storege1" ascii 
      $s9 = "\\Microsoft\\mac.txt" ascii 
      $s10 = "spytube____:" fullword ascii
      $s11 = "0D0700045F5C5B0312045A04041F40014B1D11004A1F19074A141100011200154B031C04" fullword ascii 
      $s12 = "16161A1000012B162503151851065A1A0007" fullword ascii 
      $s13 = "-- SysFile...." fullword ascii 
condition:
    any of them
}
