...
rule APT_SAP_NetWeaver_Exploitation_Activity_Apr25_1 {
   meta:
   ...
   strings:
      $x01 = "/helper.jsp?cmd=" ascii 
      $x02 = "/cache.jsp?cmd=" ascii 
condition:
    any of them
}

rule APT_SAP_NetWeaver_Exploitation_Activity_Apr25_2 {
   meta:
      description = "Detects forensic artefacts related to exploitation activity of SAP NetWeaver CVE-2025-31324"
      reference = "https://reliaquest.com/blog/threat-spotlight-reliaquest-uncovers-vulnerability-behind-sap-netweaver-compromise/"
      author = "Florian Roth"
   ...
   strings:
      $x03 = "MSBuild.exe c:\\programdata\\" ascii 
condition:
    any of them
}
