rule EXPL_WSUS_Exploitation_Indicators_Oct25 {
   ...
   strings:
      ...
      $sl1 = "at System.Data.DataSet.DeserializeDataSetSchema(SerializationInfo info, StreamingContext context" ascii 
      $sl2 = "at System.Runtime.Serialization.ObjectManager.DoFixups()" ascii 
      $sl3 = "at System.Runtime.Serialization.ObjectManager.CompleteISerializableObject" ascii 
      $sl4 = "System.Reflection.TargetInvocationException: Exception has been thrown by the target of an invocation." ascii 
      $sl5 = "ErrorWsusService.9HmtWebServices.CheckReportingWebServiceReporting WebService WebException:System.Net.WebException: Unable to connect to the remote server" ascii 

      // Encoded PowerShell command observed in exploitation attempts
      $se1 = "powershell -ec try{$r= (&{echo https://" ascii 
      $se2 = ":8531; net user /domain; ipconfig " ascii 

      // Commands observed in follow-up activity
      $sa1 = "whoami;net user /domain" ascii 
      $sa2 = "net user /domain; ipconfig /all" ascii 
condition:
      all of ($sl*)
      or 1 of ($se*)
      or all of ($sa*)
