...
rule PHISH_02Dez2015_dropped_p0o6543f_1 {
	...
	strings:
		$s1 = "netsh.exe" fullword ascii 
		$s2 = "routemon.exe" fullword ascii 
		$s3 = "script=" fullword ascii /* Goodware String - occured 4 times */
		$s4 = "disconnect" fullword ascii /* Goodware String - occured 14 times */
		...
		$s7 = "interface" fullword ascii /* Goodware String - occured 52 times */
		$s8 = "connect" fullword ascii /* Goodware String - occured 61 times */
...
rule PHISH_02Dez2015_dropped_p0o6543f_2 {
	...
	strings:
		$s1 = "Email: W0067@990.net" fullword ascii 
		$s2 = "MineExplorer Version 1.0" fullword ascii 
		$s6 = "Copy Rights by WangLei 1999.4" fullword ascii 
condition:
    any of them
}
