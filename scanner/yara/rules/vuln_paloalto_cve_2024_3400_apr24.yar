...
rule APT_UTA028_ForensicArtefacts_PaloAlto_CVE_2024_3400_Apr24_1 {
   ...
   strings:
      ...
      $x6 = "rm -rf /opt/panlogs/tmp/device_telemetry/minute/*" 
      $x7 = "$(uname -a) > /var/" 
condition:
      1 of them
}
...
rule SUSP_LNX_Base64_Download_Exec_Apr24 {
   meta:
      description = "Detects suspicious  encoded shell commands used for downloading and executing further stages"
      author = "Paul Hager"
      date = "2024-04-18"
...
rule SUSP_LNX_Base64_Exec_Apr24 {
   meta:
      description = "Detects suspicious  encoded shell commands (as seen in Palo Alto CVE-2024-3400 exploitation)"
