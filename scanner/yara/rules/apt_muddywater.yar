...
rule MuddyWater_Mal_Doc_Feb18_2 {
   ...
   strings:
      $s1 = "*\\G{00020430-0000-0000-C000-000000000046}#2.0#0#C:\\Windows\\System32\\stdole2.tlb#OLE Automation" fullword ascii 
      $s2 = "*\\G{2DF8D04C-5BFA-101B-BDE5-00AA0044DE52}#2.8#0#C:\\Program Files\\Common Files\\Microsoft Shared\\OFFICE16\\MSO.DLL#Microsoft " ascii 
      $s3 = "*\\G{00020905-0000-0000-C000-000000000046}#8.7#0#C:\\Program Files\\Microsoft Office\\Office16\\MSWORD.OLB#Microsoft Word 16.0 O" ascii 
...
rule MAL_MuddyWater_DroppedTask_Jun18_1 {
   ...
   strings:
      $x1 = "%11%\\scrobj.dll,NI,c:" ascii 

      $s1 = "AppAct = \"SOFTWARE\\Microsoft\\Connection Manager\"" fullword ascii
      $s2 = "[DefenderService]" fullword ascii 
      $s3 = "UnRegisterOCXs=EventManager" fullword ascii 
      $s4 = "ShortSvcName=\" \"" fullword ascii
condition:
    any of them
}
