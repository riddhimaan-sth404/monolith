...
rule bin_ndisk {
	...
	strings:
		$s1 = "\\Registry\\Machine\\System\\ControlSet00%d\\services\\ndisk.sys" fullword ascii 
		$s2 = "\\Registry\\Machine\\System\\ControlSet00%d\\Enum\\Root\\LEGACY_NDISK.SYS" fullword ascii 
		$s3 = "\\Driver\\DeepFrz" ascii 
		$s4 = "Microsoft Kernel Disk Manager" fullword ascii 
		$s5 = "ndisk.sys" fullword ascii 
		$s6 = "\\Device\\MSH4DEV1" ascii 
		$s7 = "\\DosDevices\\MSH4DEV1" ascii 
		$s8 = "built by: WinDDK" fullword ascii 
condition:
    any of them
}
