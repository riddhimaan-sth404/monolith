...
rule HKTL_NET_GUID_CSharpSetThreadContext {
    ...
    strings:
        $typelibguid0lo = "a1e28c8c-b3bd-44de-85b9-8aa7c18a714d" ascii 
        $typelibguid1lo = "87c5970e-0c77-4182-afe2-3fe96f785ebb" ascii 
condition:
...
rule HKTL_NET_GUID_DLL_Injection {
    ...
    strings:
        $typelibguid0lo = "3d7e1433-f81a-428a-934f-7cc7fcf1149d" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_LimeUSB_Csharp {
    ...
    strings:
        $typelibguid0lo = "94ea43ab-7878-4048-a64e-2b21b3b4366d" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_Ladon {
    ...
    strings:
        $typelibguid0lo = "c335405f-5df2-4c7d-9b53-d65adfbed412" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_WhiteListEvasion {
    ...
    strings:
        $typelibguid0lo = "858386df-4656-4a1e-94b7-47f6aa555658" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_Lime_Downloader {
    ...
    strings:
        $typelibguid0lo = "ec7afd4c-fbc4-47c1-99aa-6ebb05094173" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_DarkEye {
    ...
    strings:
        $typelibguid0lo = "0bdb9c65-14ed-4205-ab0c-ea2151866a7f" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpKatz {
    ...
    strings:
        $typelibguid0lo = "8568b4c1-2940-4f6c-bf4e-4383ef268be9" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_ExternalC2 {
    ...
    strings:
        $typelibguid0lo = "7266acbb-b10d-4873-9b99-12d2043b1d4e" ascii 
        $typelibguid1lo = "5d9515d0-df67-40ed-a6b2-6619620ef0ef" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_Povlsomware {
    ...
    strings:
        $typelibguid0lo = "fe0d5aa7-538f-42f6-9ece-b141560f7781" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_RunShellcode {
    ...
    strings:
        $typelibguid0lo = "a3ec18a3-674c-4131-a7f5-acbed034b819" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpLoginPrompt {
    ...
    strings:
        $typelibguid0lo = "c12e69cd-78a0-4960-af7e-88cbd794af97" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_Adamantium_Thief {
    ...
    strings:
        $typelibguid0lo = "e6104bc9-fea9-4ee9-b919-28156c1f2ede" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_PSByPassCLM {
    ...
    strings:
        $typelibguid0lo = "46034038-0113-4d75-81fd-eb3b483f2662" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_physmem2profit {
    ...
    strings:
        $typelibguid0lo = "814708c9-2320-42d2-a45f-31e42da06a94" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_NoAmci {
    ...
    strings:
        $typelibguid0lo = "352e80ec-72a5-4aa6-aabe-4f9a20393e8e" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpBlock {
    ...
    strings:
        $typelibguid0lo = "3cf25e04-27e4-4d19-945e-dadc37c81152" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_nopowershell {
    ...
    strings:
        $typelibguid0lo = "555ad0ac-1fdb-4016-8257-170a74cb2f55" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_LimeLogger {
    ...
    strings:
        $typelibguid0lo = "068d14ef-f0a1-4f9d-8e27-58b4317830c6" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_AggressorScripts {
    ...
    strings:
        $typelibguid0lo = "afd1ff09-2632-4087-a30c-43591f32e4e8" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_Gopher {
    ...
    strings:
        $typelibguid0lo = "b5152683-2514-49ce-9aca-1bc43df1e234" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_AVIator {
    ...
    strings:
        $typelibguid0lo = "4885a4a3-4dfa-486c-b378-ae94a221661a" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_njCrypter {
    ...
    strings:
        $typelibguid0lo = "8a87b003-4b43-467b-a509-0c8be05bf5a5" ascii 
        $typelibguid1lo = "80b13bff-24a5-4193-8e51-c62a414060ec" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpMiniDump {
    ...
    strings:
        $typelibguid0lo = "6ffccf81-6c3c-4d3f-b15f-35a86d0b497f" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_CinaRAT {
    ...
    strings:
        $typelibguid0lo = "8586f5b1-2ef4-4f35-bd45-c6206fdc0ebc" ascii 
        $typelibguid1lo = "fe184ab5-f153-4179-9bf5-50523987cf1f" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_ToxicEye {
    ...
    strings:
        $typelibguid0lo = "1bcfe538-14f4-4beb-9a3f-3f9472794902" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_Disable_Windows_Defender {
    ...
    strings:
        $typelibguid0lo = "501e3fdc-575d-492e-90bc-703fb6280ee2" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_DInvoke_PoC {
    ...
    strings:
        $typelibguid0lo = "5a869ab2-291a-49e6-a1b7-0d0f051bef0e" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_ReverseShell {
    ...
    strings:
        $typelibguid0lo = "980109e4-c988-47f9-b2b3-88d63fababdc" ascii 
        $typelibguid1lo = "8abe8da1-457e-4933-a40d-0958c8925985" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpC2 {
    ...
    strings:
        $typelibguid0lo = "62b9ee4f-1436-4098-9bc1-dd61b42d8b81" ascii 
        $typelibguid1lo = "d2f17a91-eb2d-4373-90bf-a26e46c68f76" ascii 
        $typelibguid2lo = "a9db9fcc-7502-42cd-81ec-3cd66f511346" ascii 
        $typelibguid3lo = "ca6cc2ee-75fd-4f00-b687-917fa55a4fae" ascii 
        $typelibguid4lo = "a1167b68-446b-4c0c-a8b8-2a7278b67511" ascii 
        $typelibguid5lo = "4d8c2a88-1da5-4abe-8995-6606473d7cf1" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SneakyExec {
    ...
    strings:
        $typelibguid0lo = "612590aa-af68-41e6-8ce2-e831f7fe4ccc" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_UrbanBishopLocal {
    ...
    strings:
        $typelibguid0lo = "88b8515e-a0e8-4208-a9a0-34b01d7ba533" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpShell {
    ...
    strings:
        $typelibguid0lo = "bdba47c5-e823-4404-91d0-7f6561279525" ascii 
        $typelibguid1lo = "b84548dc-d926-4b39-8293-fa0bdef34d49" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_EvilWMIProvider {
    ...
    strings:
        $typelibguid0lo = "a4020626-f1ec-4012-8b17-a2c8a0204a4b" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_GadgetToJScript {
    ...
    strings:
        $typelibguid0lo = "af9c62a1-f8d2-4be0-b019-0a7873e81ea9" ascii 
        $typelibguid1lo = "b2b3adb0-1669-4b94-86cb-6dd682ddbea3" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_AzureCLI_Extractor {
    ...
    strings:
        $typelibguid0lo = "a73cad74-f8d6-43e6-9a4c-b87832cdeace" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_UAC_Escaper {
    ...
    strings:
        $typelibguid0lo = "95359279-5cfa-46f6-b400-e80542a7336a" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_HTTPSBeaconShell {
    ...
    strings:
        $typelibguid0lo = "aca853dc-9e74-4175-8170-e85372d5f2a9" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_AmsiScanBufferBypass {
    ...
    strings:
        $typelibguid0lo = "431ef2d9-5cca-41d3-87ba-c7f5e4582dd2" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_ShellcodeLoader {
    ...
    strings:
        $typelibguid0lo = "a48fe0e1-30de-46a6-985a-3f2de3c8ac96" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_KeystrokeAPI {
    ...
    strings:
        $typelibguid0lo = "f6fec17e-e22d-4149-a8a8-9f64c3c905d3" ascii 
        $typelibguid1lo = "b7aa4e23-39a4-49d5-859a-083c789bfea2" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_ShellCodeRunner {
    ...
    strings:
        $typelibguid0lo = "634874b7-bf85-400c-82f0-7f3b4659549a" ascii 
        $typelibguid1lo = "2f9c3053-077f-45f2-b207-87c3c7b8f054" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_OffensiveCSharp {
    ...
    strings:
        $typelibguid0lo = "6c3fbc65-b673-40f0-b1ac-20636df01a85" ascii 
        $typelibguid1lo = "2bad9d69-ada9-4f1e-b838-9567e1503e93" ascii 
        $typelibguid2lo = "512015de-a70f-4887-8eae-e500fd2898ab" ascii 
        $typelibguid3lo = "1ee4188c-24ac-4478-b892-36b1029a13b3" ascii 
        $typelibguid4lo = "5c6b7361-f9ab-41dc-bfa0-ed5d4b0032a8" ascii 
        $typelibguid5lo = "048a6559-d4d3-4ad8-af0f-b7f72b212e90" ascii 
        $typelibguid6lo = "3412fbe9-19d3-41d8-9ad2-6461fcb394dc" ascii 
        $typelibguid7lo = "9ea4e0dc-9723-4d93-85bb-a4fcab0ad210" ascii 
        $typelibguid8lo = "6d2b239c-ba1e-43ec-8334-d67d52b77181" ascii 
        $typelibguid9lo = "42e8b9e1-0cf4-46ae-b573-9d0563e41238" ascii 
        $typelibguid10lo = "0d15e0e3-bcfd-4a85-adcd-0e751dab4dd6" ascii 
        $typelibguid11lo = "644dfd1a-fda5-4948-83c2-8d3b5eda143a" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SHAPESHIFTER {
    ...
    strings:
        $typelibguid0lo = "a3ddfcaa-66e7-44fd-ad48-9d80d1651228" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_Evasor {
    ...
    strings:
        $typelibguid0lo = "1c8849ef-ad09-4727-bf81-1f777bd1aef8" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_Stracciatella {
    ...
    strings:
        $typelibguid0lo = "eaafa0ac-e464-4fc4-9713-48aa9a6716fb" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_logger {
    ...
    strings:
        $typelibguid0lo = "9e92a883-3c8b-4572-a73e-bb3e61cfdc16" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_Internal_Monologue {
    ...
    strings:
        $typelibguid0lo = "0c0333db-8f00-4b68-b1db-18a9cacc1486" ascii 
        $typelibguid1lo = "84701ace-c584-4886-a3cf-76c57f6e801a" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_GRAT2 {
    ...
    strings:
        $typelibguid0lo = "5e7fce78-1977-444f-a18e-987d708a2cff" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_PowerShdll {
    ...
    strings:
        $typelibguid0lo = "36ebf9aa-2f37-4f1d-a2f1-f2a45deeaf21" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_CsharpAmsiBypass {
    ...
    strings:
        $typelibguid0lo = "4ab3b95d-373c-4197-8ee3-fe0fa66ca122" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_HastySeries {
    ...
    strings:
        $typelibguid0lo = "8435531d-675c-4270-85bf-60db7653bcf6" ascii 
        $typelibguid1lo = "47db989f-7e33-4e6b-a4a5-c392b429264b" ascii 
        $typelibguid2lo = "300c7489-a05f-4035-8826-261fa449dd96" ascii 
        $typelibguid3lo = "41bf8781-ae04-4d80-b38d-707584bf796b" ascii 
        $typelibguid4lo = "620ed459-18de-4359-bfb0-6d0c4841b6f6" ascii 
        $typelibguid5lo = "91e7cdfe-0945-45a7-9eaa-0933afe381f2" ascii 
        $typelibguid6lo = "c28e121a-60ca-4c21-af4b-93eb237b882f" ascii 
        $typelibguid7lo = "698fac7a-bff1-4c24-b2c3-173a6aae15bf" ascii 
        $typelibguid8lo = "63a40d94-5318-42ad-a573-e3a1c1284c57" ascii 
        $typelibguid9lo = "56b8311b-04b8-4e57-bb58-d62adc0d2e68" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_DreamProtectorFree {
    ...
    strings:
        $typelibguid0lo = "f7e8a902-2378-426a-bfa5-6b14c4b40aa3" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_RedSharp {
    ...
    strings:
        $typelibguid0lo = "30b2e0cf-34dd-4614-a5ca-6578fb684aea" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_ESC {
    ...
    strings:
        $typelibguid0lo = "06260ce5-61f4-4b81-ad83-7d01c3b37921" ascii 
        $typelibguid1lo = "87fc7ede-4dae-4f00-ac77-9c40803e8248" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_Csharp_Loader {
    ...
    strings:
        $typelibguid0lo = "5fd7f9fc-0618-4dde-a6a0-9faefe96c8a1" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_bantam {
    ...
    strings:
        $typelibguid0lo = "14c79bda-2ce6-424d-bd49-4f8d68630b7b" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpTask {
    ...
    strings:
        $typelibguid0lo = "13e90a4d-bf7a-4d5a-9979-8b113e3166be" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_WindowsPlague {
    ...
    strings:
        $typelibguid0lo = "cdf8b024-70c9-413a-ade3-846a43845e99" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_Misc_CSharp {
    ...
    strings:
        $typelibguid0lo = "d1421ba3-c60b-42a0-98f9-92ba4e653f3d" ascii 
        $typelibguid1lo = "2afac0dd-f46f-4f95-8a93-dc17b4f9a3a1" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpSpray {
    ...
    strings:
        $typelibguid0lo = "51c6e016-1428-441d-82e9-bb0eb599bbc8" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_Obfuscator {
    ...
    strings:
        $typelibguid0lo = "8fe5b811-a2cb-417f-af93-6a3cf6650af1" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SafetyKatz {
    ...
    strings:
        $typelibguid0lo = "8347e81b-89fc-42a9-b22c-f59a6a572dec" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_Dropless_Malware {
    ...
    strings:
        $typelibguid0lo = "23b739f7-2355-491e-a7cd-a8485d39d6d6" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_UAC_SilentClean {
    ...
    strings:
        $typelibguid0lo = "948152a4-a4a1-4260-a224-204255bfee72" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_DesktopGrabber {
    ...
    strings:
        $typelibguid0lo = "e6aa0cd5-9537-47a0-8c85-1fbe284a4380" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_wsManager {
    ...
    strings:
        $typelibguid0lo = "9480809e-5472-44f3-b076-dcdf7379e766" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_UglyEXe {
    ...
    strings:
        $typelibguid0lo = "233de44b-4ec1-475d-a7d6-16da48d6fc8d" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpDump {
    ...
    strings:
        $typelibguid0lo = "79c9bba3-a0ea-431c-866c-77004802d8a0" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_EducationalRAT {
    ...
    strings:
        $typelibguid0lo = "8a18fbcf-8cac-482d-8ab7-08a44f0e278e" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_Stealth_Kid_RAT {
    ...
    strings:
        $typelibguid0lo = "bf43cd33-c259-4711-8a0e-1a5c6c13811d" ascii 
        $typelibguid1lo = "e5b9df9b-a9e4-4754-8731-efc4e2667d88" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpCradle {
    ...
    strings:
        $typelibguid0lo = "f70d2b71-4aae-4b24-9dae-55bc819c78bb" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_BypassUAC {
    ...
    strings:
        $typelibguid0lo = "4e7c140d-bcc4-4b15-8c11-adb4e54cc39a" ascii 
        $typelibguid1lo = "cec553a7-1370-4bbc-9aae-b2f5dbde32b0" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_hanzoInjection {
    ...
    strings:
        $typelibguid0lo = "32e22e25-b033-4d98-a0b3-3d2c3850f06c" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_clr_meterpreter {
    ...
    strings:
        $typelibguid0lo = "6840b249-1a0e-433b-be79-a927696ea4b3" ascii 
        $typelibguid1lo = "67c09d37-ac18-4f15-8dd6-b5da721c0df6" ascii 
        $typelibguid2lo = "e05d0deb-d724-4448-8c4c-53d6a8e670f3" ascii 
        $typelibguid3lo = "c3cc72bf-62a2-4034-af66-e66da73e425d" ascii 
        $typelibguid4lo = "7ace3762-d8e1-4969-a5a0-dcaf7b18164e" ascii 
        $typelibguid5lo = "3296e4a3-94b5-4232-b423-44f4c7421cb3" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_BYTAGE {
    ...
    strings:
        $typelibguid0lo = "8e46ba56-e877-4dec-be1e-394cb1b5b9de" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_MultiOS_ReverseShell {
    ...
    strings:
        $typelibguid0lo = "df0dd7a1-9f6b-4b0f-801e-e17e73b0801d" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_HideFromAMSI {
    ...
    strings:
        $typelibguid0lo = "b91d2d44-794c-49b8-8a75-2fbec3fe3fe3" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_DotNetAVBypass_Master {
    ...
    strings:
        $typelibguid0lo = "4854c8dc-82b0-4162-86e0-a5bbcbc10240" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpDPAPI {
    ...
    strings:
        $typelibguid0lo = "5f026c27-f8e6-4052-b231-8451c6a73838" ascii 
        $typelibguid1lo = "2f00a05b-263d-4fcc-846b-da82bd684603" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_Telegra_Csharp_C2 {
    ...
    strings:
        $typelibguid0lo = "1d79fabc-2ba2-4604-a4b6-045027340c85" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpCompile {
    ...
    strings:
        $typelibguid0lo = "63f81b73-ff18-4a36-b095-fdcb4776da4c" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_Carbuncle {
    ...
    strings:
        $typelibguid0lo = "3f239b73-88ae-413b-b8c8-c01a35a0d92e" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_OSSFileTool {
    ...
    strings:
        $typelibguid0lo = "207aca5d-dcd6-41fb-8465-58b39efcde8b" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_Rubeus {
    ...
    strings:
        $typelibguid0lo = "658c8b7f-3664-4a95-9572-a3e5871dfc06" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_Simple_Loader {
    ...
    strings:
        $typelibguid0lo = "035ae711-c0e9-41da-a9a2-6523865e8694" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_Minidump {
    ...
    strings:
        $typelibguid0lo = "15c241aa-e73c-4b38-9489-9a344ac268a3" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpBypassUAC {
    ...
    strings:
        $typelibguid0lo = "0d588c86-c680-4b0d-9aed-418f1bb94255" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpPack {
    ...
    strings:
        $typelibguid1lo = "b59c7741-d522-4a41-bf4d-9badddebb84a" ascii 
        $typelibguid2lo = "fd6bdf7a-fef4-4b28-9027-5bf750f08048" ascii 
        $typelibguid3lo = "6dd22880-dac5-4b4d-9c91-8c35cc7b8180" ascii 
        $typelibguid5lo = "f3037587-1a3b-41f1-aa71-b026efdb2a82" ascii 
        $typelibguid6lo = "41a90a6a-f9ed-4a2f-8448-d544ec1fd753" ascii 
        $typelibguid7lo = "3787435b-8352-4bd8-a1c6-e5a1b73921f4" ascii 
        $typelibguid8lo = "fdd654f5-5c54-4d93-bf8e-faf11b00e3e9" ascii 
        $typelibguid9lo = "aec32155-d589-4150-8fe7-2900df4554c8" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_Salsa_tools {
    ...
    strings:
        $typelibguid0lo = "276004bb-5200-4381-843c-934e4c385b66" ascii 
        $typelibguid1lo = "cfcbf7b6-1c69-4b1f-8651-6bdb4b55f6b9" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_WindowsDefender_Payload_Downloader {
    ...
    strings:
        $typelibguid0lo = "2f8b4d26-7620-4e11-b296-bc46eba3adfc" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_Privilege_Escalation {
    ...
    strings:
        $typelibguid0lo = "ed54b904-5645-4830-8e68-52fd9ecbb2eb" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_Marauder {
    ...
    strings:
        $typelibguid0lo = "fff0a9a3-dfd4-402b-a251-6046d765ad78" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_AV_Evasion_Tool {
    ...
    strings:
        $typelibguid0lo = "1937ee16-57d7-4a5f-88f4-024244f19dc6" ascii 
        $typelibguid1lo = "7898617d-08d2-4297-adfe-5edd5c1b828b" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_Fenrir {
    ...
    strings:
        $typelibguid0lo = "aecec195-f143-4d02-b946-df0e1433bd2e" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_StormKitty {
    ...
    strings:
        $typelibguid0lo = "a16abbb4-985b-4db2-a80c-21268b26c73d" ascii 
        $typelibguid1lo = "98075331-1f86-48c8-ae29-29da39a8f98b" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_Crypter_Runtime_AV_s_bypass {
    ...
    strings:
        $typelibguid0lo = "c25e39a9-8215-43aa-96a3-da0e9512ec18" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_RunAsUser {
    ...
    strings:
        $typelibguid0lo = "9dff282c-93b9-4063-bf8a-b6798371d35a" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_HWIDbypass {
    ...
    strings:
        $typelibguid0lo = "47e08791-d124-4746-bc50-24bd1ee719a6" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_XORedReflectiveDLL {
    ...
    strings:
        $typelibguid0lo = "c0e49392-04e3-4abb-b931-5202e0eb4c73" ascii 
        $typelibguid1lo = "30eef7d6-cee8-490b-829f-082041bc3141" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_Sharp_Suite {
    ...
    strings:
        $typelibguid0lo = "19657be4-51ca-4a85-8ab1-f6666008b1f3" ascii 
        $typelibguid1lo = "0a382d9a-897f-431a-81c2-a4e08392c587" ascii 
        $typelibguid2lo = "467ee2a9-2f01-4a71-9647-2a2d9c31e608" ascii 
        $typelibguid3lo = "eacaa2b8-43e5-4888-826d-2f6902e16546" ascii 
        $typelibguid4lo = "629f86e6-44fe-4c9c-b043-1c9b64be6d5a" ascii 
        $typelibguid5lo = "ecf2ffe4-1744-4745-8693-5790d66bb1b8" ascii 
        $typelibguid6lo = "0a621f4c-8082-4c30-b131-ba2c98db0533" ascii 
        $typelibguid7lo = "72019dfe-608e-4ab2-a8f1-66c95c425620" ascii 
        $typelibguid8lo = "f0d28809-b712-4380-9a59-407b7b2badd5" ascii 
        $typelibguid9lo = "956a5a4d-2007-4857-9259-51cd0fb5312a" ascii 
        $typelibguid10lo = "a3b7c697-4bb6-455d-9fda-4ab54ae4c8d2" ascii 
        $typelibguid11lo = "a5f883ce-1f96-4456-bb35-40229191420c" ascii 
        $typelibguid12lo = "28978103-d90d-4618-b22e-222727f40313" ascii 
        $typelibguid13lo = "0c70c839-9565-4881-8ea1-408c1ebe38ce" ascii 
        $typelibguid14lo = "fa1d9a36-415a-4855-8c01-54b6e9fc6965" ascii 
        $typelibguid15lo = "252676f8-8a19-4664-bfb8-5a947e48c32a" ascii 
        $typelibguid16lo = "447edefc-b429-42bc-b3bc-63a9af19dbd6" ascii 
        $typelibguid17lo = "04d0b3a6-eaab-413d-b9e2-512fa8ebd02f" ascii 
        $typelibguid18lo = "5611236e-2557-45b8-be29-5d1f074d199e" ascii 
        $typelibguid19lo = "53f622eb-0ca3-4e9b-9dc8-30c832df1c7b" ascii 
        $typelibguid20lo = "414187db-5feb-43e5-a383-caa48b5395f1" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_rat_shell {
    ...
    strings:
        $typelibguid0lo = "7a15f8f6-6ce2-4ca4-919d-2056b70cc76a" ascii 
        $typelibguid1lo = "1659d65d-93a8-4bae-97d5-66d738fc6f6c" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_dotnet_gargoyle {
    ...
    strings:
        $typelibguid0lo = "76435f79-f8af-4d74-8df5-d598a551b895" ascii 
        $typelibguid1lo = "5a3fc840-5432-4925-b5bc-abc536429cb5" ascii 
        $typelibguid2lo = "6f0bbb2a-e200-4d76-b8fa-f93c801ac220" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_aresskit {
    ...
    strings:
        $typelibguid0lo = "8dca0e42-f767-411d-9704-ae0ba4a44ae8" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_DLL_Injector {
    ...
    strings:
        $typelibguid0lo = "4581a449-7d20-4c59-8da2-7fd830f1fd5e" ascii 
        $typelibguid1lo = "05f4b238-25ce-40dc-a890-d5bbb8642ee4" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_TruffleSnout {
    ...
    strings:
        $typelibguid0lo = "33842d77-bce3-4ee8-9ee2-9769898bb429" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_Anti_Analysis {
    ...
    strings:
        $typelibguid0lo = "3092c8df-e9e4-4b75-b78e-f81a0058a635" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_BackNet {
    ...
    strings:
        $typelibguid0lo = "9fdae122-cd1e-467d-a6fa-a98c26e76348" ascii 
        $typelibguid1lo = "243c279e-33a6-46a1-beab-2864cc7a499f" ascii 
        $typelibguid2lo = "a7301384-7354-47fd-a4c5-65b74e0bbb46" ascii 
        $typelibguid3lo = "982dc5b6-1123-428a-83dd-d212490c859f" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_AllTheThings {
    ...
    strings:
        $typelibguid0lo = "0547ff40-5255-42a2-beb7-2ff0dbf7d3ba" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_AddReferenceDotRedTeam {
    ...
    strings:
        $typelibguid0lo = "73c79d7e-17d4-46c9-be5a-ecef65b924e4" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_Lime_Crypter {
    ...
    strings:
        $typelibguid0lo = "f93c99ed-28c9-48c5-bb90-dd98f18285a6" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_BrowserGhost {
    ...
    strings:
        $typelibguid0lo = "2133c634-4139-466e-8983-9a23ec99e01b" ascii 
condition:
    any of them
}
...
rule HKTL_NET_GUID_SharpShot {
    ...
    strings:
        $typelibguid0lo = "057aef75-861b-4e4b-a372-cfbd8322c8e1" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_Offensive__NET {
    ...
    strings:
        $typelibguid0lo = "11fe5fae-b7c1-484a-b162-d5578a802c9c" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_RuralBishop {
    ...
    strings:
        $typelibguid0lo = "fe4414d9-1d7e-4eeb-b781-d278fe7a5619" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_DeviceGuardBypasses {
    ...
    strings:
        $typelibguid0lo = "f318466d-d310-49ad-a967-67efbba29898" ascii 
        $typelibguid1lo = "3705800f-1424-465b-937d-586e3a622a4f" ascii 
        $typelibguid2lo = "256607c2-4126-4272-a2fa-a1ffc0a734f0" ascii 
        $typelibguid3lo = "4e6ceea1-f266-401c-b832-f91432d46f42" ascii 
        $typelibguid4lo = "1e6e9b03-dd5f-4047-b386-af7a7904f884" ascii 
        $typelibguid5lo = "d85e3601-0421-4efa-a479-f3370c0498fd" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_AMSI_Handler {
    ...
    strings:
        $typelibguid0lo = "d829426c-986c-40a4-8ee2-58d14e090ef2" ascii 
        $typelibguid1lo = "86652418-5605-43fd-98b5-859828b072be" ascii 
        $typelibguid2lo = "1043649f-18e1-41c4-ae8d-ac4d9a86c2fc" ascii 
        $typelibguid3lo = "1d920b03-c537-4659-9a8c-09fb1d615e98" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_RAT_TelegramSpyBot {
    ...
    strings:
        $typelibguid0lo = "8653fa88-9655-440e-b534-26c3c760a0d3" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_TheHackToolBoxTeek {
    ...
    strings:
        $typelibguid0lo = "2aa8c254-b3b3-469c-b0c9-dcbe1dd101c0" ascii 
        $typelibguid1lo = "afeff505-14c1-4ecf-b714-abac4fbd48e7" ascii 
        $typelibguid2lo = "4cf42167-a5cf-4b2d-85b4-8e764c08d6b3" ascii 
        $typelibguid3lo = "118a90b7-598a-4cfc-859e-8013c8b9339c" ascii 
        $typelibguid4lo = "3075dd9a-4283-4d38-a25e-9f9845e5adcb" ascii 
        $typelibguid5lo = "295655e8-2348-4700-9ebc-aa57df54887e" ascii 
        $typelibguid6lo = "74efe601-9a93-46c3-932e-b80ab6570e42" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_USBTrojan {
    ...
    strings:
        $typelibguid0lo = "4eee900e-adc5-46a7-8d7d-873fd6aea83e" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_IIS_backdoor {
    ...
    strings:
        $typelibguid0lo = "3fda4aa9-6fc1-473f-9048-7edc058c4f65" ascii 
        $typelibguid1lo = "73ca4159-5d13-4a27-8965-d50c41ab203c" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_ShellGen {
    ...
    strings:
        $typelibguid0lo = "c6894882-d29d-4ae1-aeb7-7d0a9b915013" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_Mass_RAT {
    ...
    strings:
        $typelibguid0lo = "6c43a753-9565-48b2-a372-4210bb1e0d75" ascii 
        $typelibguid1lo = "92ba2a7e-c198-4d43-929e-1cfe54b64d95" ascii 
        $typelibguid2lo = "4cb9bbee-fb92-44fa-a427-b7245befc2f3" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_Browser_ExternalC2 {
    ...
    strings:
        $typelibguid0lo = "10a730cd-9517-42d5-b3e3-a2383515cca9" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_OffensivePowerShellTasking {
    ...
    strings:
        $typelibguid0lo = "d432c332-3b48-4d06-bedb-462e264e6688" ascii 
        $typelibguid1lo = "5796276f-1c7a-4d7b-a089-550a8c19d0e8" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_DoHC2 {
    ...
    strings:
        $typelibguid0lo = "9877a948-2142-4094-98de-e0fbb1bc4062" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SyscallPOC {
    ...
    strings:
        $typelibguid0lo = "1e54637b-c887-42a9-af6a-b4bd4e28cda9" ascii 
        $typelibguid1lo = "198d5599-d9fc-4a74-87f4-5077318232ad" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_Pen_Test_Tools {
    ...
    strings:
        $typelibguid0lo = "922e7fdc-33bf-48de-bc26-a81f85462115" ascii 
        $typelibguid1lo = "ad5205dd-174d-4332-96d9-98b076d6fd82" ascii 
        $typelibguid2lo = "b67e7550-f00e-48b3-ab9b-4332b1254a86" ascii 
        $typelibguid3lo = "5e95120e-b002-4495-90a1-cd3aab2a24dd" ascii 
        $typelibguid4lo = "295017f2-dc31-4a87-863d-0b9956c2b55a" ascii 
        $typelibguid5lo = "abbaa2f7-1452-43a6-b98e-10b2c8c2ba46" ascii 
        $typelibguid6lo = "a4043d4c-167b-4326-8be4-018089650382" ascii 
        $typelibguid7lo = "51abfd75-b179-496e-86db-62ee2a8de90d" ascii 
        $typelibguid8lo = "a06da7f8-f87e-4065-81d8-abc33cb547f8" ascii 
        $typelibguid9lo = "ee510712-0413-49a1-b08b-1f0b0b33d6ef" ascii 
        $typelibguid10lo = "9780da65-7e25-412e-9aa1-f77d828819d6" ascii 
        $typelibguid11lo = "7913fe95-3ad5-41f5-bf7f-e28f080724fe" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_The_Collection {
    ...
    strings:
        $typelibguid0lo = "579159ff-3a3d-46a7-b069-91204feb21cd" ascii 
        $typelibguid1lo = "5b7dd9be-c8c3-4c4f-a353-fefb89baa7b3" ascii 
        $typelibguid2lo = "43edcb1f-3098-4a23-a7f2-895d927bc661" ascii 
        $typelibguid3lo = "5f19919d-cd51-4e77-973f-875678360a6f" ascii 
        $typelibguid4lo = "17fbc926-e17e-4034-ba1b-fb2eb57f5dd3" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_Change_Lockscreen {
    ...
    strings:
        $typelibguid0lo = "78642ab3-eaa6-4e9c-a934-e7b0638bc1cc" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_LOLBITS {
    ...
    strings:
        $typelibguid0lo = "29d09aa4-ea0c-47c2-973c-1d768087d527" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_Keylogger {
    ...
    strings:
        $typelibguid0lo = "7afbc9bf-32d9-460f-8a30-35e30aa15879" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_CVE_2020_1337 {
    ...
    strings:
        $typelibguid0lo = "d9c2e3c1-e9cc-42b0-a67c-b6e1a4f962cc" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpLogger {
    ...
    strings:
        $typelibguid0lo = "36e00152-e073-4da8-aa0c-375b6dd680c4" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_AsyncRAT_C_Sharp {
    ...
    strings:
        $typelibguid0lo = "619b7612-dfea-442a-a927-d997f99c497b" ascii 
        $typelibguid1lo = "424b81be-2fac-419f-b4bc-00ccbe38491f" ascii 
        $typelibguid2lo = "37e20baf-3577-4cd9-bb39-18675854e255" ascii 
        $typelibguid3lo = "dafe686a-461b-402b-bbd7-2a2f4c87c773" ascii 
        $typelibguid4lo = "ee03faa9-c9e8-4766-bd4e-5cd54c7f13d3" ascii 
        $typelibguid5lo = "8bfc8ed2-71cc-49dc-9020-2c8199bc27b6" ascii 
        $typelibguid6lo = "d640c36b-2c66-449b-a145-eb98322a67c8" ascii 
        $typelibguid7lo = "8de42da3-be99-4e7e-a3d2-3f65e7c1abce" ascii 
        $typelibguid8lo = "bee88186-769a-452c-9dd9-d0e0815d92bf" ascii 
        $typelibguid9lo = "9042b543-13d1-42b3-a5b6-5cc9ad55e150" ascii 
        $typelibguid10lo = "6aa4e392-aaaf-4408-b550-85863dd4baaf" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_DarkFender {
    ...
    strings:
        $typelibguid0lo = "12fdf7ce-4a7c-41b6-9b32-766ddd299beb" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_IronKit {
    meta:
        ...
        modified = "2025-08-15"
    strings:
        $typelibguid0lo = "68e40495-c34a-4539-b43e-9e4e6f11a9fb" ascii 
        $typelibguid1lo = "641cd52d-3886-4a74-b590-2a05621502a4" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
*/
...
rule HKTL_NET_GUID_MinerDropper {
    ...
    strings:
        $typelibguid0lo = "46a7af83-1da7-40b2-9d86-6fd6223f6791" ascii 
        $typelibguid1lo = "8433a693-f39d-451b-955b-31c3e7fa6825" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpDomainSpray {
    ...
    strings:
        $typelibguid0lo = "76ffa92b-429b-4865-970d-4e7678ac34ea" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_iSpyKeylogger {
    ...
    strings:
        $typelibguid0lo = "ccc0a386-c4ce-42ef-aaea-b2af7eff4ad8" ascii 
        $typelibguid1lo = "816b8b90-2975-46d3-aac9-3c45b26437fa" ascii 
        $typelibguid2lo = "279b5533-d3ac-438f-ba89-3fe9de2da263" ascii 
        $typelibguid3lo = "88d3dc02-2853-4bf0-b6dc-ad31f5135d26" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SolarFlare {
    ...
    strings:
        $typelibguid0lo = "ca60e49e-eee9-409b-8d1a-d19f1d27b7e4" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_Snaffler {
    ...
    strings:
        $typelibguid0lo = "2aa060b4-de88-4d2a-a26a-760c1cefec3e" ascii 
        $typelibguid1lo = "b118802d-2e46-4e41-aac7-9ee890268f8b" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpShares {
    ...
    strings:
        $typelibguid0lo = "fe9fdde5-3f38-4f14-8c64-c3328c215cf2" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpEDRChecker {
    ...
    strings:
        $typelibguid0lo = "bdfee233-3fed-42e5-aa64-492eb2ac7047" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpClipHistory {
    ...
    strings:
        $typelibguid0lo = "1126d5b4-efc7-4b33-a594-b963f107fe82" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpGPO_RemoteAccessPolicies {
    ...
    strings:
        $typelibguid0lo = "fbb1abcf-2b06-47a0-9311-17ba3d0f2a50" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_Absinthe {
    ...
    strings:
        $typelibguid0lo = "9936ae73-fb4e-4c5e-a5fb-f8aaeb3b9bd6" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_ExploitRemotingService {
    ...
    strings:
        $typelibguid0lo = "fd17ae38-2fd3-405f-b85b-e9d14e8e8261" ascii 
        $typelibguid1lo = "1850b9bb-4a23-4d74-96b8-58f274674566" ascii 
        $typelibguid2lo = "297cbca1-efa3-4f2a-8d5f-e1faf02ba587" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_Xploit {
    ...
    strings:
        $typelibguid0lo = "4545cfde-9ee5-4f1b-b966-d128af0b9a6e" ascii 
        $typelibguid1lo = "33849d2b-3be8-41e8-a1e2-614c94c4533c" ascii 
        $typelibguid2lo = "c2dc73cc-a959-4965-8499-a9e1720e594b" ascii 
        $typelibguid3lo = "77059fa1-4b7d-4406-bc1a-cb261086f915" ascii 
        $typelibguid4lo = "a4a04c4d-5490-4309-9c90-351e5e5fd6d1" ascii 
        $typelibguid5lo = "ca64f918-3296-4b7d-9ce6-b98389896765" ascii 
        $typelibguid6lo = "10fe32a0-d791-47b2-8530-0b19d91434f7" ascii 
        $typelibguid7lo = "679bba57-3063-4f17-b491-4f0a730d6b02" ascii 
        $typelibguid8lo = "0981e164-5930-4ba0-983c-1cf679e5033f" ascii 
        $typelibguid9lo = "2a844ca2-5d6c-45b5-963b-7dca1140e16f" ascii 
        $typelibguid10lo = "7d75ca11-8745-4382-b3eb-c41416dbc48c" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_PoC {
    ...
    strings:
        $typelibguid0lo = "89f9d411-e273-41bb-8711-209fd251ca88" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpGPOAbuse {
    ...
    strings:
        $typelibguid0lo = "4f495784-b443-4838-9fa6-9149293af785" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_Watson {
    ...
    strings:
        $typelibguid0lo = "49ad5f38-9e37-4967-9e84-fe19c7434ed7" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_StandIn {
    ...
    strings:
        $typelibguid0lo = "01c142ba-7af1-48d6-b185-81147a2f7db7" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_azure_password_harvesting {
    ...
    strings:
        $typelibguid0lo = "7ad1ff2d-32ac-4c54-b615-9bb164160dac" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_PowerOPS {
    ...
    strings:
        $typelibguid0lo = "2a3c5921-7442-42c3-8cb9-24f21d0b2414" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_Random_CSharpTools {
    ...
    strings:
        $typelibguid0lo = "f7fc19da-67a3-437d-b3b0-2a257f77a00b" ascii 
        $typelibguid1lo = "47e85bb6-9138-4374-8092-0aeb301fe64b" ascii 
        $typelibguid2lo = "c7d854d8-4e3a-43a6-872f-e0710e5943f7" ascii 
        $typelibguid3lo = "d6685430-8d8d-4e2e-b202-de14efa25211" ascii 
        $typelibguid4lo = "1df925fc-9a89-4170-b763-1c735430b7d0" ascii 
        $typelibguid5lo = "817cc61b-8471-4c1e-b5d6-c754fc550a03" ascii 
        $typelibguid6lo = "60116613-c74e-41b9-b80e-35e02f25891e" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_CVE_2020_0668 {
    ...
    strings:
        $typelibguid0lo = "1b4c5ec1-2845-40fd-a173-62c450f12ea5" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_WindowsRpcClients {
    ...
    strings:
        $typelibguid0lo = "843d8862-42eb-49ee-94e6-bca798dd33ea" ascii 
        $typelibguid1lo = "632e4c3b-3013-46fc-bc6e-22828bf629e3" ascii 
        $typelibguid2lo = "a2091d2f-6f7e-4118-a203-4cea4bea6bfa" ascii 
        $typelibguid3lo = "950ef8ce-ec92-4e02-b122-0d41d83065b8" ascii 
        $typelibguid4lo = "d51301bc-31aa-4475-8944-882ecf80e10d" ascii 
        $typelibguid5lo = "823ff111-4de2-4637-af01-4bdc3ca4cf15" ascii 
        $typelibguid6lo = "5d28f15e-3bb8-4088-abe0-b517b31d4595" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpFruit {
    ...
    strings:
        $typelibguid0lo = "3da2f6de-75be-4c9d-8070-08da45e79761" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpWitness {
    ...
    strings:
        $typelibguid0lo = "b9f6ec34-4ccc-4247-bcef-c1daab9b4469" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_RexCrypter {
    ...
    strings:
        $typelibguid0lo = "10cd7c1c-e56d-4b1b-80dc-e4c496c5fec5" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharPersist {
    ...
    strings:
        $typelibguid0lo = "9d1b853e-58f1-4ba5-aefc-5c221ca30e48" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_CVE_2019_1253 {
    ...
    strings:
        $typelibguid0lo = "584964c1-f983-498d-8370-23e27fdd0399" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_scout {
    ...
    strings:
        $typelibguid0lo = "d9c76e82-b848-47d4-8f22-99bf22a8ee11" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_Grouper2 {
    ...
    strings:
        $typelibguid0lo = "5decaea3-2610-4065-99dc-65b9b4ba6ccd" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_CasperStager {
    ...
    strings:
        $typelibguid0lo = "c653a9f2-0939-43c8-9b93-fed5e2e4c7e6" ascii 
        $typelibguid1lo = "48dfc55e-6ae5-4a36-abef-14bc09d7510b" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_TellMeYourSecrets {
    ...
    strings:
        $typelibguid0lo = "9b448062-7219-4d82-9a0a-e784c4b3aa27" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpExcel4_DCOM {
    ...
    strings:
        $typelibguid0lo = "68b83ce5-bbd9-4ee3-b1cc-5e9223fab52b" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpShooter {
    ...
    strings:
        $typelibguid0lo = "56598f1c-6d88-4994-a392-af337abe5777" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_NoMSBuild {
    ...
    strings:
        $typelibguid0lo = "034a7b9f-18df-45da-b870-0e1cef500215" ascii 
        $typelibguid1lo = "59b449d7-c1e8-4f47-80b8-7375178961db" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_TeleShadow2 {
    ...
    strings:
        $typelibguid0lo = "42c5c356-39cf-4c07-96df-ebb0ccf78ca4" ascii 
        $typelibguid1lo = "0242b5b1-4d26-413e-8c8c-13b4ed30d510" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_BadPotato {
    ...
    strings:
        $typelibguid0lo = "0527a14f-1591-4d94-943e-d6d784a50549" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_LethalHTA {
    ...
    strings:
        $typelibguid0lo = "784cde17-ff0f-4e43-911a-19119e89c43f" ascii 
        $typelibguid1lo = "7e2de2c0-61dc-43ab-a0ec-c27ee2172ea6" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpStat {
    ...
    strings:
        $typelibguid0lo = "ffc5c721-49c8-448d-8ff4-2e3a7b7cc383" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SneakyService {
    ...
    strings:
        $typelibguid0lo = "897819d5-58e0-46a0-8e1a-91ea6a269d84" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpExec {
    ...
    strings:
        $typelibguid0lo = "7fbad126-e21c-4c4e-a9f0-613fcf585a71" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpCOM {
    ...
    strings:
        $typelibguid0lo = "51960f7d-76fe-499f-afbd-acabd7ba50d1" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_Inception {
    ...
    strings:
        $typelibguid0lo = "03d96b8c-efd1-44a9-8db2-0b74db5d247a" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpWMI_1 {
    ...
    strings:
        $typelibguid0lo = "bb357d38-6dc1-4f20-a54c-d664bd20677e" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_CVE_2019_1064 {
    ...
    strings:
        $typelibguid0lo = "ff97e98a-635e-4ea9-b2d0-1a13f6bdbc38" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_Tokenvator {
    ...
    strings:
        $typelibguid0lo = "4b2b3bd4-d28f-44cc-96b3-4a2f64213109" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_WheresMyImplant {
    ...
    strings:
        $typelibguid0lo = "cca59e4e-ce4d-40fc-965f-34560330c7e6" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_Naga {
    ...
    strings:
        $typelibguid0lo = "99428732-4979-47b6-a323-0bb7d6d07c95" ascii 
        $typelibguid1lo = "a2c9488f-6067-4b17-8c6f-2d464e65c535" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpBox {
    ...
    strings:
        $typelibguid0lo = "616c1afb-2944-42ed-9951-bf435cadb600" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_rundotnetdll32 {
    ...
    strings:
        $typelibguid0lo = "a766db28-94b6-4ed1-aef9-5200bbdd8ca7" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_AntiDebug {
    ...
    strings:
        $typelibguid0lo = "997265c1-1342-4d44-aded-67964a32f859" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_DInvisibleRegistry {
    ...
    strings:
        $typelibguid0lo = "31d576fb-9fb9-455e-ab02-c78981634c65" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_TikiTorch {
    ...
    strings:
        $typelibguid0lo = "806c6c72-4adc-43d9-b028-6872fa48d334" ascii 
        $typelibguid1lo = "2ef9d8f7-6b77-4b75-822b-6a53a922c30f" ascii 
        $typelibguid2lo = "8f5f3a95-f05c-4dce-8bc3-d0a0d4153db6" ascii 
        $typelibguid3lo = "1f707405-9708-4a34-a809-2c62b84d4f0a" ascii 
        $typelibguid4lo = "97421325-b6d8-49e5-adf0-e2126abc17ee" ascii 
        $typelibguid5lo = "06c247da-e2e1-47f3-bc3c-da0838a6df1f" ascii 
        $typelibguid6lo = "fc700ac6-5182-421f-8853-0ad18cdbeb39" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_HiveJack {
    ...
    strings:
        $typelibguid0lo = "e12e62fe-bea3-4989-bf04-6f76028623e3" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_DecryptAutoLogon {
    ...
    strings:
        $typelibguid0lo = "015a37fc-53d0-499b-bffe-ab88c5086040" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_UnstoppableService {
    ...
    strings:
        $typelibguid0lo = "0c117ee5-2a21-dead-beef-8cc7f0caaa86" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpWMI_2 {
    ...
    strings:
        $typelibguid0lo = "6dd22880-dac5-4b4d-9c91-8c35cc7b8180" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_EWSToolkit {
    ...
    strings:
        $typelibguid0lo = "ca536d67-53c9-43b5-8bc8-9a05fdc567ed" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SweetPotato {
    ...
    strings:
        $typelibguid0lo = "6aeb5004-6093-4c23-aeae-911d64cacc58" ascii 
        $typelibguid1lo = "1bf9c10f-6f89-4520-9d2e-aaf17d17ba5e" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_memscan {
    ...
    strings:
        $typelibguid0lo = "79462f87-8418-4834-9356-8c11e44ce189" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpStay {
    ...
    strings:
        $typelibguid0lo = "2963c954-7b1e-47f5-b4fa-2fc1f0d56aea" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpLocker {
    ...
    strings:
        $typelibguid0lo = "a6f8500f-68bc-4efc-962a-6c6e68d893af" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SauronEye {
    ...
    strings:
        $typelibguid0lo = "0f43043d-8957-4ade-a0f4-25c1122e8118" ascii 
        $typelibguid1lo = "086bf0ca-f1e4-4e8f-9040-a8c37a49fa26" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_sitrep {
    ...
    strings:
        $typelibguid0lo = "12963497-988f-46c0-9212-28b4b2b1831b" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpClipboard {
    ...
    strings:
        $typelibguid0lo = "97484211-4726-4129-86aa-ae01d17690be" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpCookieMonster {
    ...
    strings:
        $typelibguid0lo = "566c5556-1204-4db9-9dc8-a24091baaa8e" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_p0wnedShell {
    ...
    strings:
        $typelibguid0lo = "2e9b1462-f47c-48ca-9d85-004493892381" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpMove {
    ...
    strings:
        $typelibguid0lo = "8bf82bbe-909c-4777-a2fc-ea7c070ff43e" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_C_Sharp_R_A_T_Client {
    ...
    strings:
        $typelibguid0lo = "6d9e8852-e86c-4e36-9cb4-b3c3853ed6b8" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpPrinter {
    ...
    strings:
        $typelibguid0lo = "41b2d1e5-4c5d-444c-aa47-629955401ed9" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_EvilFOCA {
    ...
    strings:
        $typelibguid0lo = "f26bdb4a-5846-4bec-8f52-3c39d32df495" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_PoshC2_Misc {
    ...
    strings:
        $typelibguid0lo = "85773eb7-b159-45fe-96cd-11bad51da6de" ascii 
        $typelibguid1lo = "9d32ad59-4093-420d-b45c-5fff391e990d" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_Sharpire {
    ...
    strings:
        $typelibguid0lo = "39b75120-07fe-4833-a02e-579ff8b68331" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_Sharp_SMBExec {
    ...
    strings:
        $typelibguid0lo = "344ee55a-4e32-46f2-a003-69ad52b55945" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_MiscTools {
    ...
    strings:
        $typelibguid0lo = "384e9647-28a9-4835-8fa7-2472b1acedc0" ascii 
        $typelibguid1lo = "d7ec0ef5-157c-4533-bbcd-0fe070fbf8d9" ascii 
        $typelibguid2lo = "10085d98-48b9-42a8-b15b-cb27a243761b" ascii 
        $typelibguid3lo = "6aacd159-f4e7-4632-bad1-2ae8526a9633" ascii 
        $typelibguid4lo = "49a6719e-11a8-46e6-ad7a-1db1be9fea37" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_MemoryMapper {
    ...
    strings:
        $typelibguid0lo = "b9fbf3ac-05d8-4cd5-9694-b224d4e6c0ea" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_VanillaRAT {
    ...
    strings:
        $typelibguid0lo = "d0f2ee67-0a50-423d-bfe6-845da892a2db" ascii 
        $typelibguid1lo = "a593fcd2-c8ab-45f6-9aeb-8ab5e20ab402" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_UnmanagedPowerShell {
    ...
    strings:
        $typelibguid0lo = "dfc4eebb-7384-4db5-9bad-257203029bd9" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_Quasar {
    ...
    strings:
        $typelibguid0lo = "cfda6d2e-8ab3-4349-b89a-33e1f0dab32b" ascii 
        $typelibguid1lo = "c7c363ba-e5b6-4e18-9224-39bc8da73172" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpAdidnsdump {
    ...
    strings:
        $typelibguid0lo = "cdb02bc2-5f62-4c8a-af69-acc3ab82e741" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_DotNetToJScript {
    ...
    strings:
        $typelibguid0lo = "7e3f231c-0d0b-4025-812c-0ef099404861" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_Inferno {
    ...
    strings:
        $typelibguid0lo = "26d498f7-37ae-476c-97b0-3761e3a919f0" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpSearch {
    ...
    strings:
        $typelibguid0lo = "98fee742-8410-4f20-8b2d-d7d789ab003d" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpSecDump {
    ...
    strings:
        $typelibguid0lo = "e2fdd6cc-9886-456c-9021-ee2c47cf67b7" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_Net_GPPPassword {
    ...
    strings:
        $typelibguid0lo = "00fcf72c-d148-4dd0-9ca4-0181c4bd55c3" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_FileSearcher {
    ...
    strings:
        $typelibguid0lo = "2c879479-5027-4ce9-aaac-084db0e6d630" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_ADFSDump {
    ...
    strings:
        $typelibguid0lo = "9ee27d63-6ac9-4037-860b-44e91bae7f0d" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpRDP {
    ...
    strings:
        $typelibguid0lo = "f1df1d0f-ff86-4106-97a8-f95aaf525c54" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpCall {
    ...
    strings:
        $typelibguid0lo = "c1b0a923-0f17-4bc8-ba0f-c87aff43e799" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_ysoserial_net {
    ...
    strings:
        $typelibguid0lo = "e1e8c029-f7cd-4bd1-952e-e819b41520f0" ascii 
        $typelibguid1lo = "6b40fde7-14ea-4f57-8b7b-cc2eb4a25e6c" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_ManagedInjection {
    ...
    strings:
        $typelibguid0lo = "e5182bff-9562-40ff-b864-5a6b30c3b13b" ascii 
        $typelibguid1lo = "fdedde0d-e095-41c9-93fb-c2219ada55b1" ascii 
        $typelibguid2lo = "0dd00561-affc-4066-8c48-ce950788c3c8" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpSocks {
    ...
    strings:
        $typelibguid0lo = "2f43992e-5703-4420-ad0b-17cb7d89c956" ascii 
        $typelibguid1lo = "86d10a34-c374-4de4-8e12-490e5e65ddff" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_Sharp_WMIExec {
    ...
    strings:
        $typelibguid0lo = "0a63b0a1-7d1a-4b84-81c3-bbbfe9913029" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_KeeThief {
    ...
    strings:
        $typelibguid1lo = "39aa6f93-a1c9-497f-bad2-cc42a61d5710" ascii 
        $typelibguid3lo = "3fca8012-3bad-41e4-91f4-534aa9a44f96" ascii 
        $typelibguid4lo = "ea92f1e6-3f34-48f8-8b0a-f2bbc19220ef" ascii 
        $typelibguid5lo = "c23b51c4-2475-4fc6-9b3a-27d0a2b99b0f" ascii 
        /* $typelibguid6 = "94432a8e-3e06-4776-b9b2-3684a62bb96a" ascii FIX FPS with Microsoft files */
        $typelibguid7lo = "80ba63a4-7d41-40e9-a722-6dd58b28bf7e" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_fakelogonscreen {
    ...
    strings:
        $typelibguid0lo = "d35a55bd-3189-498b-b72f-dc798172e505" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_PoshSecFramework {
    ...
    strings:
        $typelibguid0lo = "b1ac6aa0-2f1a-4696-bf4b-0e41cf2f4b6b" ascii 
        $typelibguid1lo = "78bfcfc2-ef1c-4514-bce6-934b251666d2" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpAttack {
    ...
    strings:
        $typelibguid0lo = "5f0ceca3-5997-406c-adf5-6c7fbb6cba17" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_Altman {
    ...
    strings:
        $typelibguid0lo = "64cdcd2b-7356-4079-af78-e22210e66154" ascii 
        $typelibguid1lo = "f1dee29d-ca98-46ea-9d13-93ae1fda96e1" ascii 
        $typelibguid2lo = "33568320-56e8-4abb-83f8-548e8d6adac2" ascii 
        $typelibguid3lo = "470ec930-70a3-4d71-b4ff-860fcb900e85" ascii 
        $typelibguid4lo = "9514574d-6819-44f2-affa-6158ac1143b3" ascii 
        $typelibguid5lo = "0f3a9c4f-0b11-4373-a0a6-3a6de814e891" ascii 
        $typelibguid6lo = "9624b72e-9702-4d78-995b-164254328151" ascii 
        $typelibguid7lo = "faae59a8-55fc-48b1-a9b5-b1759c9c1010" ascii 
        $typelibguid8lo = "37af4988-f6f2-4f0c-aa2b-5b24f7ed3bf3" ascii 
        $typelibguid9lo = "c82aa2fe-3332-441f-965e-6b653e088abf" ascii 
        $typelibguid10lo = "6e531f6c-2c89-447f-8464-aaa96dbcdfff" ascii 
        $typelibguid11lo = "231987a1-ea32-4087-8963-2322338f16f6" ascii 
        $typelibguid12lo = "7da0d93a-a0ae-41a5-9389-42eff85bb064" ascii 
        $typelibguid13lo = "a729f9cc-edc2-4785-9a7d-7b81bb12484c" ascii 
        $typelibguid14lo = "55a1fd43-d23e-4d72-aadb-bbd1340a6913" ascii 
        $typelibguid15lo = "d43f240d-e7f5-43c5-9b51-d156dc7ea221" ascii 
        $typelibguid16lo = "c2e6c1a0-93b1-4bbc-98e6-8e2b3145db8e" ascii 
        $typelibguid17lo = "714ae6f3-0d03-4023-b753-fed6a31d95c7" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_BrowserPass {
    ...
    strings:
        $typelibguid0lo = "3cb59871-0dce-453b-857a-2d1e515b0b66" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_Mythic {
    ...
    strings:
        $typelibguid0lo = "91f7a9da-f045-4239-a1e9-487ffdd65986" ascii 
        $typelibguid1lo = "0405205c-c2a0-4f9a-a221-48b5c70df3b6" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_Nuages {
    ...
    strings:
        $typelibguid0lo = "e9e80ac7-4c13-45bd-9bde-ca89aadf1294" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpSniper {
    ...
    strings:
        $typelibguid0lo = "c8bb840c-04ce-4b60-a734-faf15abf7b18" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpHound3 {
    ...
    strings:
        $typelibguid0lo = "a517a8de-5834-411d-abda-2d0e1766539c" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_BlockEtw {
    ...
    strings:
        $typelibguid0lo = "daedf7b3-8262-4892-adc4-425dd5f85bca" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpWifiGrabber {
    ...
    strings:
        $typelibguid0lo = "c0997698-2b73-4982-b25b-d0578d1323c2" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpMapExec {
    ...
    strings:
        $typelibguid0lo = "bd5220f7-e1fb-41d2-91ec-e4c50c6e9b9f" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_k8fly {
    ...
    strings:
        $typelibguid0lo = "13b6c843-f3d4-4585-b4f3-e2672a47931e" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_Stealer {
    ...
    strings:
        $typelibguid0lo = "8fcd4931-91a2-4e18-849b-70de34ab75df" ascii 
        $typelibguid1lo = "e48811ca-8af8-4e73-85dd-2045b9cca73a" ascii 
        $typelibguid2lo = "d3d8a1cc-e123-4905-b3de-374749122fcf" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_PortTran {
    ...
    strings:
        $typelibguid0lo = "3a074374-77e8-4312-8746-37f3cb00e82c" ascii 
        $typelibguid1lo = "67a73bac-f59d-4227-9220-e20a2ef42782" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_gray_keylogger_2 {
    ...
    strings:
        $typelibguid0lo = "e94ca3ff-c0e5-4d1a-ad5e-f6ebbe365067" ascii 
        $typelibguid1lo = "1ed07564-b411-4626-88e5-e1cd8ecd860a" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_Lime_Miner {
    ...
    strings:
        $typelibguid0lo = "13958fb9-dfc1-4e2c-8a8d-a5e68abdbc66" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_BlackNET {
    ...
    strings:
        $typelibguid0lo = "c2b90883-abee-4cfa-af66-dfd93ec617a5" ascii 
        $typelibguid1lo = "8bb6f5b4-e7c7-4554-afd1-48f368774837" ascii 
        $typelibguid2lo = "983ae28c-91c3-4072-8cdf-698b2ff7a967" ascii 
        $typelibguid3lo = "9ac18cdc-3711-4719-9cfb-5b5f2d51fd5a" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_PlasmaRAT {
    ...
    strings:
        $typelibguid0lo = "b8a2147c-074c-46e1-bb99-c8431a6546ce" ascii 
        $typelibguid1lo = "0fcfde33-213f-4fb6-ac15-efb20393d4f3" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_Lime_RAT {
    ...
    strings:
        $typelibguid0lo = "e58ac447-ab07-402a-9c96-95e284a76a8d" ascii 
        $typelibguid1lo = "8fb35dab-73cd-4163-8868-c4dbcbdf0c17" ascii 
        $typelibguid2lo = "37845f5b-35fe-4dce-bbec-2d07c7904fb0" ascii 
        $typelibguid3lo = "83c453cf-0d29-4690-b9dc-567f20e63894" ascii 
        $typelibguid4lo = "8b1f0a69-a930-42e3-9c13-7de0d04a4add" ascii 
        $typelibguid5lo = "eaaeccf6-75d2-4616-b045-36eea09c8b28" ascii 
        $typelibguid6lo = "5b2ec674-0aa4-4209-94df-b6c995ad59c4" ascii 
        $typelibguid7lo = "e2cc7158-aee6-4463-95bf-fb5295e9e37a" ascii 
        $typelibguid8lo = "d04ecf62-6da9-4308-804a-e789baa5cc38" ascii 
        $typelibguid9lo = "8026261f-ac68-4ccf-97b2-3b55b7d6684d" ascii 
        $typelibguid10lo = "212cdfac-51f1-4045-a5c0-6e638f89fce0" ascii 
        $typelibguid11lo = "c1b608bb-7aed-488d-aa3b-0c96625d26c0" ascii 
        $typelibguid12lo = "4c84e7ec-f197-4321-8862-d5d18783e2fe" ascii 
        $typelibguid13lo = "3fc17adb-67d4-4a8d-8770-ecfd815f73ee" ascii 
        $typelibguid14lo = "f1ab854b-6282-4bdf-8b8b-f2911a008948" ascii 
        $typelibguid15lo = "aef6547e-3822-4f96-9708-bcf008129b2b" ascii 
        $typelibguid16lo = "a336f517-bca9-465f-8ff8-2756cfd0cad9" ascii 
        $typelibguid17lo = "5de018bd-941d-4a5d-bed5-fbdd111aba76" ascii 
        $typelibguid18lo = "bbfac1f9-cd4f-4c44-af94-1130168494d0" ascii 
        $typelibguid19lo = "1c79cea1-ebf3-494c-90a8-51691df41b86" ascii 
        $typelibguid20lo = "927104e1-aa17-4167-817c-7673fe26d46e" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_njRAT {
    ...
    strings:
        $typelibguid0lo = "5a542c1b-2d36-4c31-b039-26a88d3967da" ascii 
        $typelibguid1lo = "6b07082a-9256-42c3-999a-665e9de49f33" ascii 
        $typelibguid2lo = "c0a9a70f-63e8-42ca-965d-73a1bc903e62" ascii 
        $typelibguid3lo = "70bd11de-7da1-4a89-b459-8daacc930c20" ascii 
        $typelibguid4lo = "fc790ee5-163a-40f9-a1e2-9863c290ff8b" ascii 
        $typelibguid5lo = "cb3c28b2-2a4f-4114-941c-ce929fec94d3" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_Manager {
    ...
    strings:
        $typelibguid0lo = "dda73ee9-0f41-4c09-9cad-8215abd60b33" ascii 
        $typelibguid1lo = "6a0f2422-d4d1-4b7e-84ad-56dc0fd2dfc5" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_neo_ConfuserEx {
    ...
    strings:
        $typelibguid0lo = "e98490bb-63e5-492d-b14e-304de928f81a" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpAllowedToAct {
    ...
    strings:
        $typelibguid0lo = "dac5448a-4ad1-490a-846a-18e4e3e0cf9a" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SuperSQLInjectionV1 {
    ...
    strings:
        $typelibguid0lo = "d5688068-fc89-467d-913f-037a785caca7" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_ADSearch {
    ...
    strings:
        $typelibguid0lo = "4da5f1b7-8936-4413-91f7-57d6e072b4a7" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_privilege_escalation_awesome_scripts_suite {
    ...
    strings:
        $typelibguid0lo = "1928358e-a64b-493f-a741-ae8e3d029374" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_CVE_2020_1206_POC {
    ...
    strings:
        $typelibguid0lo = "3523ca04-a12d-4b40-8837-1a1d28ef96de" ascii 
        $typelibguid1lo = "d3a2f24a-ddc6-4548-9b3d-470e70dbcaab" ascii 
        $typelibguid2lo = "fb30ee05-4a35-45f7-9a0a-829aec7e47d9" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_DInvoke {
    meta:
        ...
        id = "f3b0ef47-a92c-5c5d-a9e2-09579fcb438e"
    strings:
        $typelibguid0lo = "b77fdab5-207c-4cdb-b1aa-348505c54229" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpChisel {
    ...
    strings:
        $typelibguid0lo = "f5f21e2d-eb7e-4146-a7e1-371fd08d6762" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpScribbles {
    ...
    strings:
        $typelibguid0lo = "aa61a166-31ef-429d-a971-ca654cd18c3b" ascii 
        $typelibguid1lo = "0dc1b824-c6e7-4881-8788-35aecb34d227" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpReg {
    ...
    strings:
        $typelibguid0lo = "8ef25b00-ed6a-4464-bdec-17281a4aa52f" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_MemeVM {
    ...
    strings:
        $typelibguid0lo = "ef18f7f2-1f03-481c-98f9-4a18a2f12c11" ascii 
        $typelibguid1lo = "77b2c83b-ca34-4738-9384-c52f0121647c" ascii 
        $typelibguid2lo = "14d5d12e-9a32-4516-904e-df3393626317" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpDir {
    ...
    strings:
        $typelibguid0lo = "c7a07532-12a3-4f6a-a342-161bb060b789" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_AtYourService {
    ...
    strings:
        $typelibguid0lo = "bc72386f-8b4c-44de-99b7-b06a8de3ce3f" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_LockLess {
    ...
    strings:
        $typelibguid0lo = "a91421cb-7909-4383-ba43-c2992bbbac22" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_EasyNet {
    ...
    strings:
        $typelibguid0lo = "3097d856-25c2-42c9-8d59-2cdad8e8ea12" ascii 
        $typelibguid1lo = "ba33f716-91e0-4cf7-b9bd-b4d558f9a173" ascii 
        $typelibguid2lo = "37d6dd3f-5457-4d8b-a2e1-c7b156b176e5" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpByeBear {
    ...
    strings:
        $typelibguid0lo = "a6b84e35-2112-4df2-a31b-50fde4458c5e" ascii 
        $typelibguid1lo = "3e82f538-6336-4fff-aeec-e774676205da" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpHide {
    ...
    strings:
        $typelibguid0lo = "443d8cbf-899c-4c22-b4f6-b7ac202d4e37" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpSvc {
    ...
    strings:
        $typelibguid0lo = "52856b03-5acd-45e0-828e-13ccb16942d1" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpCrashEventLog {
    ...
    strings:
        $typelibguid0lo = "98cb495f-4d47-4722-b08f-cefab2282b18" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_DotNetToJScript_LanguageModeBreakout {
    ...
    strings:
        $typelibguid0lo = "deadb33f-fa94-41b5-813d-e72d8677a0cf" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharPermission {
    ...
    strings:
        $typelibguid0lo = "84d2b661-3267-49c8-9f51-8f72f21aea47" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_RegistryStrikesBack {
    ...
    strings:
        $typelibguid0lo = "90ebd469-d780-4431-9bd8-014b00057665" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_CloneVault {
    ...
    strings:
        $typelibguid0lo = "0a344f52-6780-4d10-9a4a-cb9439f9d3de" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_donut {
    ...
    strings:
        $typelibguid0lo = "98ca74c7-a074-434d-9772-75896e73ceaa" ascii 
        $typelibguid1lo = "3c9a6b88-bed2-4ba8-964c-77ec29bf1846" ascii 
        $typelibguid2lo = "4fcdf3a3-aeef-43ea-9297-0d3bde3bdad2" ascii 
        $typelibguid3lo = "361c69f5-7885-4931-949a-b91eeab170e3" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpHandler {
    ...
    strings:
        $typelibguid0lo = "46e39aed-0cff-47c6-8a63-6826f147d7bd" ascii 
        $typelibguid1lo = "11dc83c6-8186-4887-b228-9dc4fd281a23" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_Driver_Template {
    ...
    strings:
        $typelibguid0lo = "bdb79ad6-639f-4dc2-8b8a-cd9107da3d69" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_NashaVM {
    ...
    strings:
        $typelibguid0lo = "f9e63498-6e92-4afd-8c13-4f63a3d964c3" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpSQLPwn {
    ...
    strings:
        $typelibguid0lo = "c442ea6a-9aa1-4d9c-9c9d-7560a327089c" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_Group3r {
    ...
    strings:
        $typelibguid0lo = "868a6c76-c903-4a94-96fd-a2c6ba75691c" ascii 
        $typelibguid1lo = "caa7ab97-f83b-432c-8f9c-c5f1530f59f7" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_TokenStomp {
    ...
    strings:
        $typelibguid0lo = "8aac271f-9b0b-4dc3-8aa6-812bb7a57e7b" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_KrbRelay {
    ...
    strings:
        $typelibguid0lo = "ed839154-90d8-49db-8cdd-972d1a6b2cfd" ascii 
        $typelibguid1lo = "3b47eebc-0d33-4e0b-bab5-782d2d3680af" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SQLRecon {
    ...
    strings:
        $typelibguid0lo = "612c7c82-d501-417a-b8db-73204fdfda06" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_Certify {
    ...
    strings:
        $typelibguid0_v1 = "64524ca5-e4d0-41b3-acc3-3bdbefd40c97" ascii 
        $typelibguid0_v2 = "15cfadd8-5f6c-424b-81dc-c028312d025f" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_Aladdin {
    ...
    strings:
        $typelibguid0lo = "b2b3adb0-1669-4b94-86cb-6dd682ddbea3" ascii 
        $typelibguid1lo = "c47e4d64-cc7f-490e-8f09-055e009f33ba" ascii 
        $typelibguid2lo = "32a91b0f-30cd-4c75-be79-ccbd6345de99" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpLdapRelayScan {
    ...
    strings:
        $typelibguid0lo = "a93ee706-a71c-4cc1-bf37-f26c27825b68" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_LdapSignCheck {
    ...
    strings:
        $typelibguid0lo = "21f398a9-bc35-4bd2-b906-866f21409744" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpSCCM {
    ...
    strings:
        $typelibguid0lo = "03652836-898e-4a9f-b781-b7d86e750f60" ascii 
        $typelibguid1lo = "e4d9ef39-0fce-4573-978b-abf8df6aec23" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_Koh {
    ...
    strings:
        $typelibguid0lo = "4d5350c8-7f8c-47cf-8cde-c752018af17e" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_ForgeCert {
    ...
    strings:
        $typelibguid0lo = "bd346689-8ee6-40b3-858b-4ed94f08d40a" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_Crassus {
    ...
    strings:
        $typelibguid0lo = "7e9729aa-4cf2-4d0a-8183-7fb7ce7a5b1a" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_RestrictedAdmin {
    ...
    strings:
        $typelibguid0lo = "79f11fc0-abff-4e1f-b07c-5d65653d8952" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_p2p {
    ...
    strings:
        $typelibguid0lo = "33456e72-f8e8-4384-88c4-700867df12e2" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpWSUS {
    ...
    strings:
        $typelibguid0lo = "42cabb74-1199-40f1-9354-6294bba8d3a4" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpImpersonation {
    ...
    strings:
        $typelibguid0lo = "27a85262-8c87-4147-a908-46728ab7fc73" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpCloud {
    ...
    strings:
        $typelibguid0lo = "ca4e257e-69c1-45c5-9375-ba7874371892" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpSSDP {
    ...
    strings:
        $typelibguid0lo = "6e383de4-de89-4247-a41a-79db1dc03aaa" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_WireTap {
    ...
    strings:
        $typelibguid0lo = "b5067468-f656-450a-b29c-1c84cfe8dde5" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_KittyLitter {
    ...
    strings:
        $typelibguid0lo = "449cf269-4798-4268-9a0d-9a17a08869ba" ascii 
        $typelibguid1lo = "e7a509a4-2d44-4e10-95bf-b86cb7767c2c" ascii 
        $typelibguid2lo = "b2b8dd4f-eba6-42a1-a53d-9a00fe785d66" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpView {
    ...
    strings:
        $typelibguid0lo = "22a156ea-2623-45c7-8e50-e864d9fc44d3" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_Farmer {
    ...
    strings:
        $typelibguid0lo = "37da2573-d9b5-4fc2-ae11-ccb6130cea9f" ascii 
        $typelibguid1lo = "49acf861-1c10-49a1-bf26-139a3b3a9227" ascii 
        $typelibguid2lo = "9a6c028f-423f-4c2c-8db3-b3499139b822" ascii 
        $typelibguid3lo = "1c896837-e729-46a9-92b9-3bbe7ac2c90d" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_AESShellCodeInjector {
    ...
    strings:
        $typelibguid0lo = "b016da9e-12a1-4f1d-91a1-d681ae54e92c" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_Get_RBCD_Threaded {
    ...
    strings:
        $typelibguid0lo = "e20dc2ed-6455-4101-9d78-fccac1cb7a18" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_Whisker {
    ...
    strings:
        $typelibguid0lo = "42750ac0-1bff-4f25-8c9d-9af144403bad" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_ShadowSpray {
    ...
    strings:
        $typelibguid0lo = "7e47d586-ddc6-4382-848c-5cf0798084e1" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_MalSCCM {
    ...
    strings:
        $typelibguid0lo = "5439cecd-3bb3-4807-b33f-e4c299b71ca2" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SpoolSample {
    ...
    strings:
        $typelibguid0lo = "640c36b4-f417-4d85-b031-83a9d23c140b" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpOxidResolver {
    ...
    strings:
        $typelibguid0lo = "ce59f8ff-0ecf-41e9-a1fd-1776ca0b703d" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_Sharpcat {
    ...
    strings:
        $typelibguid0 = "d16fd95f-23ce-4f8d-8763-b9f5a9cdd0c3" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpNamedPipePTH {
    ...
    strings:
        $typelibguid0 = "344ee55a-4e32-46f2-a003-69ad52b55945" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpTokenFinder {
    ...
    strings:
        $typelibguid0 = "572804d3-dbd6-450a-be64-2e3cb54fd173" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpRODC {
    ...
    strings:
        $typelibguid0 = "d305f8a3-019a-4cdf-909c-069d5b483613" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_GMSAPasswordReader {
    ...
    strings:
        $typelibguid0 = "c8112750-972d-4efa-a75b-da9b8a4533c7" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_SharpShareFinder {
    ...
    strings:
        $typelibguid0 = "64bfeb18-b65c-4a83-bde0-b54363b09b71" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
...
rule HKTL_NET_GUID_POSTDump {
    ...
    strings:
        $typelibguid0 = "e54195f0-060c-4b24-98f2-ad9fb5351045" ascii 
condition:
        (uint16(0) == 0x5A4D and uint32(uint32(0x3C)) == 0x00004550) and any of them
}
