...
rule Shamoon2_Wiper {
   ...
   strings:
      $a1 = "\\??\\%s\\System32\\%s.exe" fullword ascii 
      $x1 = "IWHBWWHVCIDBRAFUASIIWURRTWRTIBIVJDGWTRRREFDEAEBIAEBJGGCSVUHGVJUHADIEWAFGWADRUWDTJBHTSITDVVBCIDCWHRHVTDVCDESTHWSUAEHGTWTJWFIRTBRB" ascii 
      $s1 = "UFWYNYNTS" fullword ascii 
      $s2 = "\\\\?\\ElRawDisk" fullword ascii 
condition:
    any of them
}
