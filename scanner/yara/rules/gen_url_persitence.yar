...
rule Methodology_Contains_Shortcut_OtherURIhandlers
{
  ...
  strings:
    $file = "URL="
    $filenegate = /[\x0a\x0d](Base|)URL\s*=\s*(https?|file):\/\//
    $url_clsid = "[{000214A0-0000-0000-C000-000000000046}]"
    $url_explicit = "[InternetShortcut]" 
condition:
    any of them
...
rule Methodology_Suspicious_Shortcut_IconShenanigans_dotDL
{
  meta:
    ...
    date = "27.09.2019"
  strings:
    $icon = /[\x0a\x0d]IconFile=[^\x0d]*\.dl\x0d/ ascii
    $url_clsid = "[{000214A0-0000-0000-C000-000000000046}]"
    $url_explicit = "[InternetShortcut]" 
condition:
    any of them
...
rule Methodology_Suspicious_Shortcut_IconNotFromExeOrDLLOrICO
{
  ...
  strings:
    $icon = "IconFile="
    $icon_negate = /[\x0a\x0d]IconFile=[^\x0d]*\.(dll|exe|ico)\x0d/
    $url_clsid = "[{000214A0-0000-0000-C000-000000000046}]"
    $url_explicit = "[InternetShortcut]" 
condition:
    any of them
...
rule Methodology_Suspicious_Shortcut_Evasion
{
  ...
  strings:
    $URI = /[\x0a\x0d](IconFile|(Base|)URL)[^\x0d=]+/
    $filetype_clsid = "[{000214A0-0000-0000-C000-000000000046}]"
    $filetype_explicit = "[InternetShortcut]" 
condition:
    any of them
}
...
rule Methodology_Suspicious_Shortcut_LOLcommand
{
  ...
  strings:
    $file1 = /[\x0a\x0d](IconFile|(Base|)URL)\s*=[^\x0d]*(powershell|cmd|certutil|mshta|wscript|cscript|rundll32|wmic|regsvr32|msbuild)(\.exe|)[^\x0d]{2,50}\x0d/
    $url_clsid = "[{000214A0-0000-0000-C000-000000000046}]"
    $url_explicit = "[InternetShortcut]" 
condition:
    any of them
...
rule Methodology_Suspicious_Shortcut_ScriptURL
{
  ...
  strings:
    $file1 = /[\x0a\x0d](IconFile|(Base|)URL)\s*=[^\x0d]*script:/
//    $file2 = /IconFile=script:/
    $url_clsid = "[{000214A0-0000-0000-C000-000000000046}]"
    $url_explicit = "[InternetShortcut]" 
condition:
    any of them
