...
rule HiddenCobra_Rule_2 {
   meta:
      ...
      date = "2017-06-13"
   strings:
      $STR1 = "Wating" ascii fullword
      $STR2 = "Reamin" ascii fullword
      $STR3 = "laptos" ascii fullword
condition:
      ( uint16(0) == 0x5A4D
        uint16(0) == 0xCFD0
        uint16(0) == 0xC3D4
